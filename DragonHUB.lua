...
local Window = Fluent:CreateWindow({Title = "â¤ï¸caveirahubâ¤ï¸",SubTitle = "| By:caveira ",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
...
local Tabs = {
  Settings = Window:AddTab({Title = "âš™ï¸Setting Farm", Icon = ""}),
  Main = Window:AddTab({Title = "ðŸš€Farm", Icon = ""}),
  Melee = Window:AddTab({Title = "ðŸ¥ŠFighting Style", Icon = ""}),
  Quests = Window:AddTab({Title = "ðŸ’ŽItems Farm", Icon = ""}),
  Valentine = Window:AddTab({Title = "â¤ï¸Valentine", Icon = ""}),
  SeaEvent = Window:AddTab({Title = "ðŸŒŠSea Events", Icon = ""}),
  Mirage = Window:AddTab({Title = "ðŸŒ´Mirage + RaceV4", Icon = ""}),
  Drago = Window:AddTab({Title = "ðŸ‰Drago Dojo", Icon = ""}),
  Prehistoric = Window:AddTab({Title = "ðŸ¦•Prehistoric", Icon = ""}),
  Raids = Window:AddTab({Title = "ðŸŒ€Raid", Icon = ""}),
  Combat = Window:AddTab({Title = "âš”ï¸Combat PVP", Icon = ""}),
  Travel = Window:AddTab({Title = "ðŸ—ºï¸Travel", Icon = ""}),
  Fruit = Window:AddTab({Title = "ðŸŽFruits", Icon = ""}),
  Shop = Window:AddTab({Title = "ðŸ›’Shop", Icon = ""}),
  Misc = Window:AddTab({Title = "âš¡Misc", Icon = ""})
}

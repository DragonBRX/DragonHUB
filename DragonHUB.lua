...
task.spawn(function()
    pcall(function()
        _G.DragonHUBInterfaceReady = false
        local player = game:GetService("Players").LocalPlayer
        local playerGui = player:WaitForChild("PlayerGui")
        local old = playerGui:FindFirstChild("DragonHUBBoot")
        if old then old:Destroy() end
        local gui = Instance.new("ScreenGui")
        gui.Name = "DragonHUBBoot"
        ...
        status.Size = UDim2.fromOffset(310, 34)
        status.BackgroundColor3 = Color3.fromRGB(19, 19, 31)
        status.BorderSizePixel = 0
        status.Text = "DragonHUB carregando..."
        status.TextColor3 = Color3.fromRGB(232, 232, 255)
        status.TextSize = 14
        ...
        repeat task.wait(0.25) until _G.DragonHUBInterfaceReady or os.clock() - started >= 20
        if _G.DragonHUBInterfaceReady then
            status.Text = "DragonHUB iniciado"
            task.wait(2)
            gui:Destroy()
        else
            status.Text = "DragonHUB parou antes da interface"
            status.BackgroundColor3 = Color3.fromRGB(120, 35, 35)
        end
    end)
end)
...
repeat task.wait(0.1) until game:IsLoaded() and plr.PlayerGui:FindFirstChild("Main")
...
local DragonAutoEnabled = true
local DragonAutoState = "Analyzing account"
...
Tabs.Automatic:AddButton({
  ...
  Callback = function()
    ...
    _G.TwFruits = false
    _G.InstanceF = false
    SetDragonStatus("Stopped | Execute the script again to restart")
  end
})

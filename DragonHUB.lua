...
do
    ...
    world.Size = UDim2.new(1, -40, 0, 34)
    world.Position = UDim2.new(0, 20, 0, 64)
    world.BackgroundColor3 = Color3.fromRGB(26, 26, 42)
    ...
    objective.Size = UDim2.new(1, -40, 0, 66)
    objective.Position = UDim2.new(0, 20, 0, 172)
    objective.BackgroundColor3 = Color3.fromRGB(26, 26, 42)
    ...
    startButton.Size = UDim2.new(0.5, -25, 0, 42)
    startButton.Position = UDim2.new(0, 20, 0, 254)
    startButton.BackgroundColor3 = Color3.fromRGB(45, 190, 90)
    ...
    stopButton.Size = UDim2.new(0.5, -25, 0, 42)
    stopButton.Position = UDim2.new(0.5, 5, 0, 254)
    ...
    skipped.Size = UDim2.new(1, -40, 0, 58)
    skipped.Position = UDim2.new(0, 20, 0, 310)
    ...
    minimize.MouseButton1Click:Connect(function()
        ...
        win.Size = minimized and UDim2.new(0, 560, 0, 44) or UDim2.new(0, 560, 0, 390)
	...
	if _G.Level then
	  pcall(function()
	    ...
	    elseif QuestGui.Visible == true then
		  ...
		  else _tp(QuestData[4])if replicated:FindFirstChild(QuestData[1]) then _tp(replicated:FindFirstChild(QuestData[1]).HumanoidRootPart.CFrame * CFrame.new(0, 30, 0))end end
		end
	  end)
	end
  end
...
local function GetDragonBeli()
  local BeliValue = plr.Data:FindFirstChild("Beli")
...
spawn(function()
  while task.wait(1) do
    if _G.Random_Auto and os.clock() >= DragonGachaNextAttempt then
      ...
      if Price and CurrentBeli >= Price then
        DragonGachaNextAttempt = os.clock() + 60
        local BeliBefore = CurrentBeli
        pcall(function()
          replicated.Remotes.CommF_:InvokeServer("Cousin", "Buy")
        end)
        task.wait(1)
        if GetDragonBeli() < BeliBefore then
      ...
      elseif CurrentLevel < 50 then
        ...
        DragonGachaNextAttempt = os.clock() + 5
      end
    end
  end
end)

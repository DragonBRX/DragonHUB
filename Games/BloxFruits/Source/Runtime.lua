if _G.DragonSelectedModePreset then
    local PlaceId = game.PlaceId
    _G.DragonSelectedMode = _G.DragonSelectedModePreset
    _G.DragonDetectedGame = "Blox Fruits"
    _G.DragonDetectedWorld = (PlaceId == 2753915549 or PlaceId == 85211729168715) and "Sea 1" or (PlaceId == 4442272183
        or PlaceId == 79091703265657)
        and "Sea 2" or "Sea 3"
    _G.DragonUILibrary = nil
...
do
    ...
    if WorldName then
        Automatic.MouseButton1Click:Connect(function()
            _G.DragonSelectedMode = "AUTOMATIC" end)
        Hub.MouseButton1Click:Connect(function()
            _G.DragonSelectedMode = "HUB" end)
...
_G.DragonHubCallbacks = _G.DragonHubCallbacks or {}
_G.DragonHubActions = _G.DragonHubActions or {}
_G.DragonHubControlInfo = _G.DragonHubControlInfo or {}
_G.DragonPendingHubValues = _G.DragonPendingHubValues or {}
_G.DragonPendingHubActions = _G.DragonPendingHubActions or {}
...
if _G.DragonSelectedMode == "AUTOMATIC" then
    ...
    win.Name = "Win"
    win.Size = UDim2.new(0, 430, 0, 340)
    win.Position = UDim2.new(0.5, -215, 0.5, -170)
    win.BackgroundColor3 = Color3.fromRGB(12, 13, 21)
    ...
    winGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(17, 18, 31)),
    ...
    accentGradient.Color = ColorSequence.new(Color3.fromRGB(59, 130, 246), Color3.fromRGB(168, 85, 247))
    accentGradient.Parent = accent
    local title = Instance.new("TextLabel")
    title.Size = UDim2.new(1, -105, 1, 0)
    title.Position = UDim2.new(0, 18, 0, 0)
    title.BackgroundTransparency = 1
    title.Text = "DragonHUB | Automatic"
    ...
    minimize.BackgroundColor3 = Color3.fromRGB(34, 34, 53)
    minimize.BorderSizePixel = 0
    minimize.Text = "-"
    minimize.TextColor3 = Color3.fromRGB(232, 232, 255)
    ...
    world.Size = UDim2.new(1, -32, 0, 28)
    world.Position = UDim2.new(0, 16, 0, 54)
    world.BackgroundColor3 = Color3.fromRGB(23, 24, 39)
    world.BorderSizePixel = 0
    world.Text = "Mundo: detectando"
    world.TextColor3 = Color3.fromRGB(144, 144, 184)
    world.TextSize = 11
    world.Font = Enum.Font.Gotham
    world.Parent = win
    local worldCorner = Instance.new("UICorner")
    worldCorner.CornerRadius = UDim.new(0, 7)
    worldCorner.Parent = world
    local status = Instance.new("TextLabel")
    status.Size = UDim2.new(1, -32, 0, 42)
    status.Position = UDim2.new(0, 16, 0, 90)
    status.BackgroundColor3 = Color3.fromRGB(31, 32, 51)
    status.BorderSizePixel = 0
    status.Text = "Parado | Pressione Iniciar"
    ...
    objective.Size = UDim2.new(1, -32, 0, 48)
    objective.Position = UDim2.new(0, 16, 0, 140)
    objective.BackgroundColor3 = Color3.fromRGB(23, 24, 39)
    objective.BorderSizePixel = 0
    objective.Text = "Objetivo: aguardando inicio"
    objective.TextColor3 = Color3.fromRGB(190, 185, 215)
    objective.TextSize = 11
    objective.Font = Enum.Font.Gotham
    objective.TextWrapped = true
    objective.Parent = win
    local objectiveCorner = Instance.new("UICorner")
    objectiveCorner.CornerRadius = UDim.new(0, 7)
    objectiveCorner.Parent = objective
    local attackPanel = Instance.new("Frame")
    attackPanel.Size = UDim2.new(1, -32, 0, 54)
    attackPanel.Position = UDim2.new(0, 16, 0, 196)
    attackPanel.BackgroundColor3 = Color3.fromRGB(23, 24, 39)
    attackPanel.BorderSizePixel = 0
    attackPanel.Parent = win
    local attackPanelCorner = Instance.new("UICorner")
    attackPanelCorner.CornerRadius = UDim.new(0, 7)
    attackPanelCorner.Parent = attackPanel
    local attackTitle = Instance.new("TextLabel")
    attackTitle.Size = UDim2.new(0.7, 0, 0, 24)
    attackTitle.Position = UDim2.new(0, 12, 0, 2)
    attackTitle.BackgroundTransparency = 1
    attackTitle.Text = "Velocidade do ataque"
    attackTitle.TextColor3 = Color3.fromRGB(205, 205, 230)
    attackTitle.TextSize = 11
    attackTitle.Font = Enum.Font.GothamMedium
    attackTitle.TextXAlignment = Enum.TextXAlignment.Left
    attackTitle.Parent = attackPanel
    local attackValue = Instance.new("TextLabel")
    attackValue.Size = UDim2.new(0.3, -12, 0, 24)
    attackValue.Position = UDim2.new(0.7, 0, 0, 2)
    attackValue.BackgroundTransparency = 1
    attackValue.TextColor3 = Color3.fromRGB(129, 140, 248)
    attackValue.TextSize = 11
    attackValue.Font = Enum.Font.GothamBold
    attackValue.TextXAlignment = Enum.TextXAlignment.Right
    attackValue.Parent = attackPanel
    local attackSlider = Instance.new("TextButton")
    attackSlider.Size = UDim2.new(1, -24, 0, 24)
    attackSlider.Position = UDim2.new(0, 12, 0, 26)
    attackSlider.BackgroundTransparency = 1
    attackSlider.Text = ""
    attackSlider.AutoButtonColor = false
    attackSlider.Parent = attackPanel
    local attackBar = Instance.new("Frame")
    attackBar.Size = UDim2.new(1, 0, 0, 6)
    attackBar.Position = UDim2.new(0, 0, 0.5, -3)
    attackBar.BackgroundColor3 = Color3.fromRGB(48, 49, 70)
    attackBar.BorderSizePixel = 0
    attackBar.Parent = attackSlider
    local attackBarCorner = Instance.new("UICorner")
    attackBarCorner.CornerRadius = UDim.new(1, 0)
    attackBarCorner.Parent = attackBar
    local attackFill = Instance.new("Frame")
    attackFill.BackgroundColor3 = Color3.fromRGB(99, 102, 241)
    attackFill.BorderSizePixel = 0
    attackFill.Parent = attackBar
    local attackFillCorner = Instance.new("UICorner")
    attackFillCorner.CornerRadius = UDim.new(1, 0)
    attackFillCorner.Parent = attackFill
    local attackKnob = Instance.new("Frame")
    attackKnob.Size = UDim2.new(0, 14, 0, 14)
    attackKnob.AnchorPoint = Vector2.new(0.5, 0.5)
    attackKnob.BackgroundColor3 = Color3.fromRGB(238, 238, 255)
    attackKnob.BorderSizePixel = 0
    attackKnob.ZIndex = 2
    attackKnob.Parent = attackBar
    local attackKnobCorner = Instance.new("UICorner")
    attackKnobCorner.CornerRadius = UDim.new(1, 0)
    attackKnobCorner.Parent = attackKnob
    local function SetAttackRatio(Ratio)
        Ratio = math.clamp(Ratio, 0, 1)
        local Delay = math.floor((0.5 - Ratio * 0.45) * 100 + 0.5) / 100
        _G.DragonAttackDelay = Delay
        attackValue.Text = string.format("%.2fs", Delay)
        attackFill.Size = UDim2.new(Ratio, 0, 1, 0)
        attackKnob.Position = UDim2.new(Ratio, 0, 0.5, 0)
    end
    local function SetAttackFromInput(Input)
        if attackBar.AbsoluteSize.X <= 0 then return end
        SetAttackRatio((Input.Position.X - attackBar.AbsolutePosition.X) / attackBar.AbsoluteSize.X)
    end
    SetAttackRatio((0.5 - _G.DragonAttackDelay) / 0.45)
    local sliderDragging = false
    attackSlider.InputBegan:Connect(function(Input)
        if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
            sliderDragging = true
            SetAttackFromInput(Input)
        end
    end)
...
if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
    ...
    startButton.Position = UDim2.new(0, 16, 0, 258)
    ...
    stopButton.Parent = win
    local stopCorner = Instance.new("UICorner")
    stopCorner.CornerRadius = UDim.new(0, 7)
    stopCorner.Parent = stopButton
    local skipped = Instance.new("TextLabel")
    skipped.Size = UDim2.new(1, -32, 0, 26)
    skipped.Position = UDim2.new(0, 16, 0, 306)
    skipped.BackgroundTransparency = 1
    skipped.Text = "Ignorados: V4, engrenagem azul, Mirage, Kitsune e Leviathan"
    skipped.TextColor3 = Color3.fromRGB(90, 90, 122)
    skipped.TextSize = 9
    skipped.Font = Enum.Font.Gotham
    skipped.TextWrapped = true
    skipped.Parent = win
    _G.DragonStatusLabel = status
    _G.DragonObjectiveLabel = objective
    _G.DragonWorldLabel = world
    _G.DragonHUBInterfaceReady = true
    startButton.MouseButton1Click:Connect(function()
        _G.DragonAutoEnabled = true
        _G.DragonStartRequested = true
        status.Text = "Iniciando analise da conta"
        status.TextColor3 = Color3.fromRGB(45, 190, 90)
        objective.Text = "Objetivo: analisando nivel, mundo e inventario"
        if _G.DragonStartAll then pcall(_G.DragonStartAll) end
    end)
    stopButton.MouseButton1Click:Connect(function()
        ...
        status.Text = "Parado"
        status.TextColor3 = Color3.fromRGB(245, 158, 11)
        objective.Text = "Objetivo: nenhum"
        if _G.DragonStopAll then pcall(_G.DragonStopAll) end
    end)
    close.MouseButton1Click:Connect(function()
        sg.Enabled = false end)
    local minimized = false
    minimize.MouseButton1Click:Connect(function()
        minimized = not minimized
        win.Size = minimized and UDim2.new(0, 430, 0, 44) or UDim2.new(0, 430, 0, 340)
    ...
    uis.InputChanged:Connect(function(input)
        if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
            ...
            win.Position = UDim2.new(winStart.X.Scale, winStart.X.Offset + delta.X, winStart.Y.Scale,
...
if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
    ...
    uis.InputBegan:Connect(function(input, processed)
        if not processed and input.KeyCode == Enum.KeyCode.RightShift then sg.Enabled = not sg.Enabled end
    end)
end
...
task.spawn(function()
    ...
    spawn(function()
        while task.wait(math.clamp(tonumber(_G.DragonAttackDelay) or 0.2, 0.05, 0.5)) do
            if _G.DragonAutoEnabled then AttackAll() end
        end
    end)
    ...
    local Config = {
        ...
        ComboResetTime = 0.3,
        MaxCombo = 4,
        HitboxLimbs = {"RightLowerArm", "RightUpperArm", "LeftLowerArm", "LeftUpperArm", "RightHand",
             "LeftHand"},
    ...
    function FastAttack.new()
        local self = setmetatable({
            ...
            EnemyRootPart = nil,
            Connections = {},
            Overheat = {Dragonstorm = {MaxOverheat = 3, Cooldown = 0, TotalOverheat = 0, Distance = 350,
                 Shooting = false}},

            ShootsPerTarget = {["Dual Flintlock"] = 2},
            SpecialShoots = {["Skull Guitar"] = "TAP", ["Bazooka"] = "Position", ["Cannon"] = "Position",
                 ["Dragonstorm"] = "Overheat"}
        }, FastAttack)

        pcall(function()
            self.CombatFlags = require(Modules.Flags).COMBAT_REMOTE_THREAD
            self.ShootFunction = getupvalue(require(ReplicatedStorage.Controllers.CombatController).Attack,
                 9)
    ...
    function FastAttack:Attack()
        local AttackDelay = math.clamp(tonumber(_G.DragonAttackDelay) or Config.AttackCooldown, 0.05,
             0.5)
        if not Config.AutoClickEnabled or (tick() - self.Debounce) < AttackDelay then return end
        local Character = Player.Character
        ...
        local Cooldown = Equipped:FindFirstChild("Cooldown") and Equipped.Cooldown.Value or AttackDelay
    ...
    table.insert(AttackInstance.Connections, RunService.Stepped:Connect(function()
        if _G.DragonAutoEnabled then AttackInstance:Attack() end
    end))
    ...
    function Getplayerhit()
        ...
        for _, v in pairs(workspace.Characters:GetChildren()) do
            if v.Name ~= game.Players.LocalPlayer.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart")
...
repeat task.wait() until game.Players.LocalPlayer:FindFirstChild("Data") and game.Players.LocalPlayer.Data:FindFirstChild("Level")
do
  ply = game.Players
  plr = ply.LocalPlayer
...
plr.CharacterAdded:Connect(function(Character)
  local NewRoot = Character:WaitForChild("HumanoidRootPart", 15)
  if NewRoot then Root = NewRoot end
  local NewEnergy = Character:FindFirstChild("Energy") or Character:WaitForChild("Energy", 5)
  if NewEnergy then Energy = NewEnergy.Value end
end)
repeat task.wait(0.1) until plr.PlayerGui:FindFirstChild("Main")
...
Marines = function()
    replicated.Remotes.CommF_:InvokeServer("SetTeam","Marines") end
Pirates = function()
    replicated.Remotes.CommF_:InvokeServer("SetTeam","Pirates") end
if World1 then Boss = {"The Gorilla King","Bobby","The Saw","Yeti","Mob Leader","Vice Admiral","Saber Expert",
    "Warden","Chief Warden",
    "Swan","Magma Admiral","Fishman Lord","Wysper","Thunder God","Cyborg","Ice Admiral","Greybeard"}
elseif World2 then Boss = {"Diamond","Jeremy","Fajita","Don Swan","Smoke Admiral","Awakened Ice Admiral",
    "Tide Keeper","Darkbeard",
    "Cursed Captain","Order"}
elseif World3 then Boss = {"Stone","Hydra Leader","Kilo Admiral","Captain Elephant","Beautiful Pirate",
    "Cake Queen","Longma",
    "Soul Reaper"}
end
if World1 then MaterialList = {"Leather + Scrap Metal", "Angel Wings", "Magma Ore", "Fish Tail"}
elseif World2 then MaterialList = {"Leather + Scrap Metal", "Radioactive Material", "Ectoplasm", "Mystic Droplet",
     "Magma Ore",
     "Vampire Fang"}
elseif World3 then MaterialList = {"Scrap Metal", "Demonic Wisp", "Conjured Cocoa", "Dragon Scale", "Gunpowder",
     "Fish Tail",
     "Mini Tusk"}
end
local DungeonTables = {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha",
    "Sand","Bird: Phoenix",
    "Dough"}
local RenMon = {"Snow Lurker","Arctic Warrior","Hidden Key","Awakened Ice Admiral"}
local CursedTables = {["Mob"] = "Mythological Pirate",["Mob2"] = "Cursed Skeleton","Hell's Messenger",
...
local PosMsList = {["Pirate Millionaire"] = CFrame.new(-712.8272705078125, 98.5770492553711, 5711.9541015625),
    ["Pistol Billionaire"] = CFrame.new(-723.4331665039062,
     147.42906188964844, 5931.9931640625),["Dragon Crew Warrior"] = CFrame.new(7021.50439453125, 55.76270294189453,
          -730.1290893554688),
    ["Dragon Crew Archer"] = CFrame.new(6625, 378, 244),["Female Islander"] = CFrame.new(4692.7939453125,
         797.9766845703125,
     858.8480224609375),["Venomous Assailant"] = CFrame.new(4902, 670, 39), ["Marine Commodore"] = CFrame.new(2401,
          123, -7589),
    ["Marine Rear Admiral"] = CFrame.new(3588, 229, -7085),["Fishman Raider"] = CFrame.new(-10941, 332,
         -8760),["Fishman Captain"] = CFrame.new(-11035,
     332, -9087),["Forest Pirate"] = CFrame.new(-13446, 413, -7760),["Mythological Pirate"] = CFrame.new(-13510,
          584, -6987),
    ["Jungle Pirate"] = CFrame.new(-11778, 426, -10592),["Musketeer Pirate"] = CFrame.new(-13282, 496,
         -9565),["Reborn Skeleton"] = CFrame.new(-8764,
     142, 5963),["Living Zombie"] = CFrame.new(-10227, 421, 6161),["Demonic Soul"] = CFrame.new(-9579,
          6, 6194),["Posessed Mummy"] = CFrame.new(-9579,
     6, 6194),["Peanut Scout"] = CFrame.new(-1993, 187, -10103),["Peanut President"] = CFrame.new(-2215,
          159, -10474),["Ice Cream Chef"] = CFrame.new(-877,
     118, -11032),["Ice Cream Commander"] = CFrame.new(-877, 118, -11032),["Cookie Crafter"] = CFrame.new(-2021,
          38, -12028),
    ["Cake Guard"] = CFrame.new(-2024, 38, -12026),["Baking Staff"] = CFrame.new(-1932, 38, -12848),["Head Baker"] = CFrame.new(-1932,

     38, -12848),["Cocoa Warrior"] = CFrame.new(95, 73, -12309),["Chocolate Bar Battler"] = CFrame.new(647,
          42, -12401),["Sweet Thief"] = CFrame.new(116,
     36, -12478),["Candy Rebel"] = CFrame.new(47, 61, -12889),["Ghost"] = CFrame.new(5251, 5, 1111)}
...
gay = pcall(function()
  ...
  local Water = WorldOrigin and WorldOrigin:FindFirstChild("Foam;")
  if Water then Water:Destroy() end
end)
local Attack = {}
Attack.__index = Attack
Attack.Alive = function(model)
    if not model then return end local Humanoid = model:FindFirstChild("Humanoid")
    return Humanoid and Humanoid.Health > 0 end
Attack.Pos = function(model,dist)
  local Target = model and (model:IsA("BasePart") and model or model:FindFirstChild("HumanoidRootPart"))
  return Root and Target and (Root.Position - Target.Position).Magnitude <= dist or false
end
Attack.Dist = function(model,dist)
    return (Root.Position - model:FindFirstChild("HumanoidRootPart").Position).Magnitude <= dist end
...
if ToolTip == "Blox Fruit" then
       ...
       _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,
      30,0) * CFrame.Angles(0,math.rad(180),0))end
...
if ToolTip == "Blox Fruit" then
       ...
       _tp(model.HumanoidRootPart.CFrame * CFrame.new(0,
      30,8) * CFrame.Angles(0,math.rad(180),0))end
if RandomCFrame then
       wait(0.1)
           _tp(model.HumanoidRootPart.CFrame * CFrame.new(0, 30, 25))
           wait(0.1)
...
if (_G.FarmMastery_G and not SoulGuitar) or (_G.FarmMastery_Dev) or (_G.FarmBlazeEM) or (_G.Prehis_Skills)
    or (_G.SeaBeast1
    or _G.FishBoat or _G.PGB or _G.Leviathan1 or _G.Complete_Trials) or (_G.AimMethod and ABmethod == "AimBots Skill")
        or (_G.AimMethod
    and ABmethod == "Auto Aimbots") then
            args[2] = MousePos
...
GetConnectionEnemies = function(a)
  for i,v in pairs(replicated:GetChildren()) do
    if v:IsA("Model") and  ((typeof(a) == "table" and table.find(a, v.Name)) or v.Name == a) and v:FindFirstChild("Humanoid")
...
if e:IsA("BlurEffect") or e:IsA("SunRaysEffect") or e:IsA("ColorCorrectionEffect") or e:IsA("BloomEffect")
...
local DragonFruitPrices = {}
local DragonFruitPricesLoaded = false

local function NormalizeDragonFruitName(Name)
  return string.lower(tostring(Name or "")):gsub("fruit", ""):gsub("[^%w]", "")
end

local function LoadDragonFruitPrices()
  if DragonFruitPricesLoaded then return end
  DragonFruitPricesLoaded = true
  pcall(function()
    for _, FruitData in pairs(replicated.Remotes.CommF_:InvokeServer("GetFruits")) do
      local Price = tonumber(FruitData.Price) or 0
      local FullName = NormalizeDragonFruitName(FruitData.Name)
      DragonFruitPrices[FullName] = math.max(DragonFruitPrices[FullName] or 0, Price)
      local FirstName = tostring(FruitData.Name or ""):match("^([^%-:]+)")
      local LastName = tostring(FruitData.Name or ""):match(":%s*(.+)$")
      if FirstName then
        FirstName = NormalizeDragonFruitName(FirstName)
        DragonFruitPrices[FirstName] = math.max(DragonFruitPrices[FirstName] or 0, Price)
      end
      if LastName then
        LastName = NormalizeDragonFruitName(LastName)
        DragonFruitPrices[LastName] = math.max(DragonFruitPrices[LastName] or 0, Price)
      end
    end
  end)
end

local function GetDragonFruitPrice(Fruit)
  LoadDragonFruitPrices()
  local Handle = Fruit and Fruit:FindFirstChild("Handle")
  local Names = {}
  local FruitOriginalName = Fruit and Fruit:GetAttribute("OriginalName")
  local HandleOriginalName = Handle and Handle:GetAttribute("OriginalName")
  if FruitOriginalName then table.insert(Names, FruitOriginalName) end
  if HandleOriginalName then table.insert(Names, HandleOriginalName) end
  if Fruit and Fruit.Name then table.insert(Names, Fruit.Name) end
  local BestPrice = 0
  for _, Name in ipairs(Names) do
    local Normalized = NormalizeDragonFruitName(Name)
    if DragonFruitPrices[Normalized] then
      BestPrice = math.max(BestPrice, DragonFruitPrices[Normalized])
    else
      for FruitName, Price in pairs(DragonFruitPrices) do
        if #FruitName >= 3 and (string.find(Normalized, FruitName, 1, true) or string.find(FruitName,
             Normalized, 1, true)) then
...
UpdStFruit = function()
  ...
  table.sort(Fruits, function(A, B)
    return GetDragonFruitPrice(A) > GetDragonFruitPrice(B)
  end)
...
local function PullDragonFruitInstantly(Fruit)
  if not _G.InstanceF or not Fruit or not string.find(Fruit.Name, "Fruit") then return end
  local Handle = Fruit:FindFirstChild("Handle") or Fruit:WaitForChild("Handle", 5)
  if not Handle then return end
  for _ = 1, 20 do
    if not _G.InstanceF or not Fruit.Parent then break end
    local Character = plr.Character
    local CurrentRoot = Character and Character:FindFirstChild("HumanoidRootPart")
    if not CurrentRoot then break end
    Handle.CFrame = CurrentRoot.CFrame
    task.wait()
  end
end
...
workspace.ChildAdded:Connect(function(Item)
  if string.find(Item.Name, "Fruit") then
    task.spawn(PullDragonFruitInstantly, Item)
  end
end)
Getmoon = function()
  if World1 then
...
DropFruits = function()
  for _,v3 in next, plr.Backpack:GetChildren() do
    if string.find(v3.Name, "Fruit") then
      EquipWeapon(v3.Name)
          wait(.1)
      if plr.PlayerGui.Main.Dialogue.Visible == true then plr.PlayerGui.Main.Dialogue.Visible = false end EquipWeapon(v3.Name)
          plr.Character:FindFirstChild(v3.Name).EatRemote:InvokeServer("Drop")
    end
  end
  for a,b2 in pairs(plr.Character:GetChildren()) do
    if string.find(b2.Name, "Fruit") then EquipWeapon(b2.Name)
        wait(.1)
    if plr.PlayerGui.Main.Dialogue.Visible == true then plr.PlayerGui.Main.Dialogue.Visible = false end EquipWeapon(b2.Name)
        ...
        if ((typeof(gc) == "function") and (getfenv(gc).script == plr.Character.Soru)) then
          for _, v in next, getupvalues(gc) do
            if (typeof(v) == "table") then
              repeat wait(Sec)
                  v.LastUse = 0 until not Var or (plr.Character.Humanoid.Health <= 0)
            end
          end
        end
      end
...
_tp = function(target)
  ...
  tween:Play()
  task.spawn(function()
      while tween.PlaybackState == Enum.PlaybackState.Playing do if not shouldTween then tween:Cancel()
      break end task.wait(0.1) end end)
end
...
notween = function(p)
    plr.Character.HumanoidRootPart.CFrame = p end
function BTP(p)
    local player = game.Players.LocalPlayer
...
spawn(function()
  while task.wait() do
    pcall(function()
if _G.SailBoat_Hydra or _G.WardenBoss or _G.AutoFactory or _G.HighestMirage or _G.HCM or _G.PGB or _G.Leviathan1
    or _G.UPGDrago
    or _G.Complete_Trials or _G.TpDrago_Prehis or _G.BuyDrago or _G.AutoFireFlowers or _G.DT_Uzoth or _G.AutoBerry
        or _G.Prehis_Find
    or _G.Prehis_Skills or _G.Prehis_DB or _G.Prehis_DE or _G.FarmBlazeEM or _G.Dojoo or _G.CollectPresent
        or _G.AutoLawKak
    or _G.TpLab or _G.AutoPhoenixF or _G.AutoFarmChest or _G.AutoHytHallow or _G.LongsWord or _G.BlackSpikey
        or _G.AutoHolyTorch
    or _G.TrainDrago  or _G.AutoSaber or _G.FarmMastery_Dev or _G.CitizenQuest or _G.AutoEctoplasm or _G.KeysRen
        or _G.Auto_Rainbow_Haki
    or _G.obsFarm or _G.AutoBigmom or _G.Doughv2 or _G.AuraBoss or _G.Raiding or _G.Auto_Cavender or _G.TpPly
        or _G.Bartilo_Quest
    or _G.Level or _G.FarmEliteHunt or _G.AutoZou or _G.AutoFarm_Bone or getgenv().AutoMaterial or _G.CraftVM
        or _G.FrozenTP
    or _G.TPDoor or _G.AcientOne or _G.AutoFarmNear or _G.AutoRaidCastle or _G.DarkBladev3 or _G.AutoFarmRaid
        or _G.Auto_Cake_Prince
    or _G.Addealer or _G.TPNpc or _G.TwinHook or _G.FindMirage or _G.FarmChestM or _G.Shark or _G.TerrorShark
        or _G.Piranha
    or _G.MobCrew or _G.SeaBeast1 or _G.FishBoat or _G.AutoPole or _G.AutoPoleV2 or _G.Auto_SuperHuman
        or _G.AutoDeathStep
    or _G.Auto_SharkMan_Karate or _G.Auto_Electric_Claw or _G.AutoDragonTalon or _G.Auto_Def_DarkCoat
        or _G.Auto_God_Human
    or _G.Auto_Tushita or _G.AutoMatSoul or _G.AutoKenVTWO or _G.AutoSerpentBow or _G.AutoFMon or _G.Auto_Soul_Guitar
        or _G.TPGEAR
    or _G.AutoSaw or _G.AutoTridentW2 or _G.Auto_StartRaid or _G.AutoEvoRace or _G.AutoGetQuestBounty
        or _G.MarinesCoat or _G.TravelDres
    or _G.Defeating or _G.DummyMan or _G.Auto_Yama or _G.Auto_SwanGG or _G.SwanCoat or _G.AutoEcBoss
        or _G.Auto_Mink or _G.Auto_Human
    or _G.Auto_Skypiea or _G.Auto_Fish or _G.CDK_TS or _G.CDK_YM or _G.CDK or _G.AutoFarmGodChalice or _G.AutoFistDarkness
    or _G.AutoMiror or _G.Teleport or _G.AutoKilo or _G.AutoGetUsoap or _G.Praying or _G.TryLucky or _G.AutoColShad
        or _G.AutoUnHaki
    or _G.Auto_DonAcces or _G.AutoRipIngay or _G.DragoV3 or _G.DragoV1 or _G.SailBoats or NextIs or _G.FarmGodChalice
        or _G.IceBossRen
    or senth or senth2 or _G.Lvthan or _G.beasthunter or _G.DangerLV or _G.Relic123 or _G.tweenKitsune
        or _G.Collect_Ember
    or _G.AutofindKitIs or _G.snaguine or _G.TwFruits or _G.tweenKitShrine or _G.Tp_LgS or _G.Tp_MasterA
        or _G.tweenShrine
    or _G.FarmMastery_G or _G.FarmMastery_S then
        shouldTween = true
    ...
    if World1 then
         if _G.FindBoss=="The Gorilla King"then
            ...
            PosQBoss=CFrame.new(-1601.6553955078,36.85213470459,153.38809204102)
                PosB=CFrame.new(-1088.75977,8.13463783,-488.559906,-0.707134247,0,0.707079291,0,1,0,-0.707079291,
                    0,-0.707134247)
        ...
        elseif _G.FindBoss=="Warden"then
             bMon="Warden"
                 Qname="ImpelQuest"
                 Qdata=1;
            PosB=CFrame.new(5278.04932,2.15167475,944.101929,0.220546961,-4.49946401e-06,0.975376427,
                -1.95412576e-05,1,9.03162072e-06,
                -0.975376427,-2.10519756e-05,0.220546961)
                PosQBoss=CFrame.new(5191.86133,2.84020686,686.438721,-0.731384635,0,0.681965172,0,1,0,
                    -0.681965172,0,-0.731384635)
        elseif _G.FindBoss=="Chief Warden"then
             bMon="Chief Warden"
                 Qname="ImpelQuest"
                 Qdata=2;
            PosB=CFrame.new(5206.92578,0.997753382,814.976746,0.342041343,-0.00062915677,0.939684749,
                0.00191645394,0.999998152,
                -2.80422337e-05,-0.939682961,0.00181045406,0.342041939)
                PosQBoss=CFrame.new(5191.86133,2.84020686,686.438721,-0.731384635,0,0.681965172,0,1,0,
                    -0.681965172,0,-0.731384635)
        elseif _G.FindBoss=="Swan"then
             bMon="Swan"
                 Qname="ImpelQuest"
                 Qdata=3;
            PosB=CFrame.new(5325.09619,7.03906584,719.570679,-0.309060812,0,0.951042235,0,1,0,-0.951042235,
                0,-0.309060812)
                PosQBoss=CFrame.new(5191.86133,2.84020686,686.438721,-0.731384635,0,0.681965172,0,1,0,
                    -0.681965172,0,-0.731384635)
        ...
        elseif _G.FindBoss=="Ice Admiral"then
             bMon="Ice Admiral"
                 Qdata=nil;
            PosQBoss=CFrame.new(1266.08948,26.1757946,-1399.57678,-0.573599219,0,-0.81913656,0,1,0,0.81913656,
                0,-0.573599219)
                PosB=CFrame.new(1266.08948,26.1757946,-1399.57678,-0.573599219,0,-0.81913656,0,1,0,0.81913656,
                    0,-0.573599219)
    ...
    if World3 then
        ...
        elseif _G.FindBoss=="Cake Queen"then
             bMon="Cake Queen"
                 ...
                 Qdata=3;
            PosQBoss=CFrame.new(-819.376709,64.9259796,-10967.2832,-0.766061664,0,0.642767608,0,1,0,-0.642767608,
                0,-0.766061664)
                PosB=CFrame.new(-678.648804,381.353943,-11114.2012,-0.908641815,0.00149294338,0.41757378,
                    0.00837114919,0.999857843,
                0.0146408929,-0.417492568,0.0167988986,-0.90852499)
...
QuestCheck=function()
    ...
    if World1 then
         if a==1 or a<=9 then
             if tostring(TeamSelf)=="Marines"then
                 Mon="Trainee"
                     ...
                     Qdata=1;
                NameMon="Trainee"
                    PosM=CFrame.new(-2709.67944,24.5206585,2104.24585,-0.744724929,-3.97967455e-08,-0.667371571,
                        4.32403588e-08,
                    1,-1.07884304e-07,0.667371571,-1.09201515e-07,-0.744724929)
                    PosQ=CFrame.new(-2709.67944,24.5206585,2104.24585,-0.744724929,-3.97967455e-08,-0.667371571,
                        4.32403588e-08,
                    1,-1.07884304e-07,0.667371571,-1.09201515e-07,-0.744724929)
        ...
        elseif a==30 or a<=39 then
            ...
            Qname="BuggyQuest1"
                NameMon="Pirate"
                PosQ=CFrame.new(-1141.07483,4.10001802,3831.5498,0.965929627,-0,-0.258804798,0,1,-0,0.258804798,
                    0,0.965929627)
        ...
        elseif a==60 or a<=74 then
            ...
            Qname="DesertQuest"
                ...
                PosQ=CFrame.new(894.488647,5.14000702,4392.43359,0.819155693,-0,-0.573571265,0,1,-0,0.573571265,
                    0,0.819155693)
        ...
        elseif a==90 or a<=99 then
            ...
            Qname="SnowQuest"
                NameMon="Snow Bandit"
                PosQ=CFrame.new(1389.74451,88.1519318,-1298.90796,-0.342042685,0,0.939684391,0,1,0,-0.939684391,
                    0,-0.342042685)
        ...
        elseif a==150 or a<=174 then
            ...
            Qname="SkyQuest"
                NameMon="Sky Bandit"
                PosQ=CFrame.new(-4839.53027,716.368591,-2619.44165,0.866007268,0,0.500031412,0,1,0,-0.500031412,
                    0,0.866007268)
        ...
        elseif a==190 or a<=209 then
            ...
            Qname="PrisonerQuest"
                NameMon="Prisoner"
                PosQ=CFrame.new(5308.93115,1.65517521,475.120514,-0.0894274712,-5.00292918e-09,-0.995993316,
                    1.60817859e-09,
                1,-5.16744869e-09,0.995993316,-2.06384709e-09,-0.0894274712)
        ...
        elseif a==250 or a<=274 then
            ...
            Qname="ColosseumQuest"
                ...
                PosQ=CFrame.new(-1580.04663,6.35000277,-2986.47534,-0.515037298,0,-0.857167721,0,1,0,
        ...
        elseif a==300 or a<=324 then
            ...
            Qname="MagmaQuest"
                ...
                PosQ=CFrame.new(-5313.37012,10.9500084,8515.29395,-0.499959469,0,0.866048813,0,1,0,-0.866048813,
                    0,-0.499959469)
        ...
        elseif a==375 or a<=399 then
            ...
            Qname="FishmanQuest"
                ...
                if _G.Level and (PosQ.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>10000 then
                 replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625,11.6796875,
                     1819.7841796875))
            end
        ...
        elseif a==450 or a<=474 then
            ...
            Qname="SkyExp1Quest"
                NameMon="God's Guard"
                PosQ=CFrame.new(-4721.88867,843.874695,-1949.96643,0.996191859,-0,-0.0871884301,0,1,-0,
                    0.0871884301,0,0.996191859)
                PosM=CFrame.new(-4710.04296875,845.2769775390625,-1927.3079833984375)
                if _G.Level and (PosQ.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>10000 then
                 replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275,872.54248,
                     -1667.55688))
            end
        elseif a==475 or a<=524 then
            ...
            Qname="SkyExp1Quest"
                NameMon="Shanda"
                PosQ=CFrame.new(-7859.09814,5544.19043,-381.476196,-0.422592998,0,0.906319618,0,1,0,-0.906319618,
                    0,-0.422592998)
                PosM=CFrame.new(-7678.48974609375,5566.40380859375,-497.2156066894531)
                if _G.Level and (PosQ.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>10000 then
                 replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813,
        ...
        elseif a==625 or a<=649 then
            ...
            Qname="FountainQuest"
                ...
                PosQ=CFrame.new(5259.81982,37.3500175,4050.0293,0.087131381,0,0.996196866,0,1,0,-0.996196866,
                    0,0.087131381)
    ...
    elseif World2 then
         if a==700 or a<=724 then
            ...
            Qname="Area1Quest"
                NameMon="Raider"
                PosQ=CFrame.new(-429.543518,71.7699966,1836.18188,-0.22495985,0,-0.974368095,0,1,0,0.974368095,
                    0,-0.22495985)
        ...
        elseif a==775 or a<=799 then
            ...
            Qname="Area2Quest"
                NameMon="Swan Pirate"
                PosQ=CFrame.new(638.43811,71.769989,918.282898,0.139203906,0,0.99026376,0,1,0,-0.99026376,
                    0,0.139203906)
        ...
        elseif a==800 or a<=874 then
            ...
            NameMon="Factory Staff"
                PosQ=CFrame.new(632.698608,73.1055908,918.666321,-0.0319722369,8.96074881e-10,-0.999488771,
                    1.36326533e-10,
                1,8.92172336e-10,0.999488771,-1.07732087e-10,-0.0319722369)
        ...
        elseif a==875 or a<=899 then
            ...
            Qname="MarineQuest3"
                ...
                PosQ=CFrame.new(-2440.79639,71.7140732,-3216.06812,0.866007268,0,0.500031412,0,1,0,-0.500031412,
                    0,0.866007268)
        ...
        elseif a==950 or a<=974 then
            ...
            Qname="ZombieQuest"
                NameMon="Zombie"
                PosQ=CFrame.new(-5497.06152,47.5923004,-795.237061,-0.29242146,0,-0.95628953,0,1,0,0.95628953,
                    0,-0.29242146)
        ...
        elseif a==1000 or a<=1049 then
            ...
            Qname="SnowMountainQuest"
                ...
                PosQ=CFrame.new(609.858826,400.119904,-5372.25928,-0.374604106,0,0.92718488,0,1,0,-0.92718488,
                    0,-0.374604106)
        ...
        elseif a==1100 or a<=1124 then
            ...
            Qname="IceSideQuest"
                ...
                PosQ=CFrame.new(-6064.06885,15.2422857,-4902.97852,0.453972578,-0,-0.891015649,0,1,-0,
        ...
        elseif a==1175 or a<=1199 then
            ...
            Qname="FireSideQuest"
                NameMon="Magma Ninja"
                PosQ=CFrame.new(-5428.03174,15.0622921,-5299.43457,-0.882952213,0,0.469463557,0,1,0,-0.469463557,
                    0,-0.882952213)
        ...
        elseif a==1250 or a<=1274 then
            ...
            Qname="ShipQuest1"
                ...
                if _G.Level and (PosQ.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>500 then
                 replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.21252441406,
                     126.9760055542,32852.83203125))
            end
        ...
        elseif a==1350 or a<=1374 then
            ...
            Qname="FrostQuest"
                ...
                PosQ=CFrame.new(5667.6582,26.7997818,-6486.08984,-0.933587909,0,-0.358349502,0,1,0,0.358349502,
                    0,-0.933587909)
        ...
        elseif a==1425 or a<=1449 then
            ...
            Qname="ForgottenQuest"
                NameMon="Sea Soldier"
                PosQ=CFrame.new(-3054.44458,235.544281,-10142.8193,0.990270376,-0,-0.13915664,0,1,-0,
    ...
    elseif World3 then
        ...
        elseif a==1650 or a<=1699 then
            ...
            NameMon="Venomous Assailant"
                PosQ=CFrame.new(4697.5918,1100.65137,946.401978,0.579397917,-4.19689783e-10,0.81504482,
                    -1.49287818e-10,1,
                6.21053986e-10,-0.81504482,-4.81513662e-10,0.579397917)
                PosM=CFrame.new(4697.5918,1100.65137,946.401978,0.579397917,-4.19689783e-10,0.81504482,
                    -1.49287818e-10,1,
                6.21053986e-10,-0.81504482,-4.81513662e-10,0.579397917)
        elseif a==1700 or a<=1724 then
            ...
            Qname="MarineTreeIsland"
                ...
                PosQ=CFrame.new(2180.54126,27.8156815,-6741.5498,-0.965929747,0,0.258804798,0,1,0,-0.258804798,
                    0,-0.965929747)
        ...
        elseif a==1775 or a<=1799 then
            ...
            Qname="DeepForestIsland3"
                ...
                PosQ=CFrame.new(-10581.6563,330.872955,-8761.18652,-0.882952213,0,0.469463557,0,1,0,-0.469463557,
                    0,-0.882952213)
        ...
        elseif a==1825 or a<=1849 then
            ...
            Qname="DeepForestIsland"
                ...
                PosQ=CFrame.new(-13234.04,331.488495,-7625.40137,0.707134247,-0,-0.707079291,0,1,-0,0.707079291,
                    0,0.707134247)
        ...
        elseif a==1900 or a<=1924 then
            ...
            Qname="DeepForestIsland2"
                ...
                PosQ=CFrame.new(-12680.3818,389.971039,-9902.01953,-0.0871315002,0,0.996196866,0,1,0,
        ...
        elseif a==2200 or a<=2224 then
            ...
            Qname="CakeQuest1"
                ...
                PosQ=CFrame.new(-2021.32007,37.7982254,-12028.7295,0.957576931,-8.80302053e-08,0.288177818,
                    6.9301187e-08,
                1,7.51931211e-08,-0.288177818,-5.2032135e-08,0.957576931)
        ...
        elseif a==2250 or a<=2274 then
            ...
            Qname="CakeQuest2"
                ...
                PosQ=CFrame.new(-1927.91602,37.7981339,-12842.5391,-0.96804446,4.22142143e-08,0.250778586,
                    4.74911062e-08,
                1,1.49904711e-08,-0.250778586,2.64211941e-08,-0.96804446)
        ...
        elseif a==2450 or a<=2474 then
            ...
            Qname="TikiQuest1"
                NameMon="Isle Outlaw"
                PosQ=CFrame.new(-16548.8164,55.6059914,-172.8125,0.213092566,-0,-0.977032006,0,1,-0,0.977032006,
                    0,0.213092566)
        ...
        elseif a==2525 or a<=2550 then
            ...
            Qname="TikiQuest2"
                ...
                PosQ=CFrame.new(-16541.0215,57.3082275,1051.46118,0.0410757065,-0,-0.999156058,0,1,-0,
...
if _G.DragonSelectedMode == "HUB" and not _G.DragonExternalHubUI then
local DragonUILibrary = (function()
  local Library = {}
  ...
  local function Round(Object, Radius)
    New("UICorner", {CornerRadius = UDim.new(0, Radius or 6), Parent = Object})
  end
  function Library:CreateWindow(Config)
    local Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
    pcall(function()
        Parent = game:GetService("CoreGui") end)
    pcall(function()
        if gethui then Parent = gethui() end end)
    local GuiName = _G.DragonExternalHubUI and "DragonHUBRuntimeInterface" or "DragonHUBInterface"
    local Old = Parent:FindFirstChild(GuiName)
    if Old then Old:Destroy() end
    local Gui = New("ScreenGui", {Name = GuiName, ResetOnSpawn = false, ZIndexBehavior = Enum.ZIndexBehavior.Sibling})
    pcall(function()
        if protectgui then protectgui(Gui) elseif syn and syn.protect_gui then syn.protect_gui(Gui) end end)
    if not pcall(function()
        Gui.Parent = Parent end) then
      Gui.Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
    end
    Gui.Enabled = not _G.DragonExternalHubUI
    _G.DragonHUBInterfaceReady = true
    local WindowSize = Config.Size or UDim2.fromOffset(560, 390)
    local Main = New("Frame", {Parent = Gui, Size = WindowSize, Position = UDim2.new(0.5, -WindowSize.X.Offset / 2,
         0.5, -WindowSize.Y.Offset / 2),
         BackgroundColor3 = Color3.fromRGB(16, 17, 28), BorderSizePixel = 0, Active = true, Draggable = true})
    Round(Main, 10)
    New("UIStroke", {Parent = Main, Color = Color3.fromRGB(75, 78, 120), Thickness = 1})
    local Header = New("Frame", {Parent = Main, Size = UDim2.new(1, 0, 0, 48), BackgroundColor3 = Color3.fromRGB(24,
         25, 42),
         BorderSizePixel = 0})
    Round(Header, 10)
    New("TextLabel", {Parent = Header, Size = UDim2.new(1, -55, 1, 0), Position = UDim2.fromOffset(16,
         0), BackgroundTransparency = 1,
         Text = Config.Title or "DragonHUB", TextColor3 = Color3.fromRGB(238, 238, 255), TextSize = 16,
              Font = Enum.Font.GothamBold,
         TextXAlignment = Enum.TextXAlignment.Left})
    local Close = New("TextButton", {Parent = Header, Size = UDim2.fromOffset(28, 24), Position = UDim2.new(1,
         -36, 0, 10),
         BackgroundColor3 = Color3.fromRGB(200, 50, 50), BorderSizePixel = 0, Text = "X", TextColor3 = Color3.new(1,
              1, 1),
         TextSize = 11, Font = Enum.Font.GothamBold})
    Round(Close, 7)
    Close.MouseButton1Click:Connect(function()
        Gui.Enabled = false end)
    local Side = New("ScrollingFrame", {Parent = Main, Size = UDim2.new(0, Config.TabWidth or 145, 1,
         -58), Position = UDim2.fromOffset(8,
         54), BackgroundColor3 = Color3.fromRGB(22, 23, 38), BorderSizePixel = 0, ScrollBarThickness = 3,
              AutomaticCanvasSize = Enum.AutomaticSize.Y,
         CanvasSize = UDim2.new()})
    Round(Side, 8)
    New("UIListLayout", {Parent = Side, Padding = UDim.new(0, 5), SortOrder = Enum.SortOrder.LayoutOrder})
    New("UIPadding", {Parent = Side, PaddingTop = UDim.new(0, 7), PaddingLeft = UDim.new(0, 6), PaddingRight = UDim.new(0,

         6), PaddingBottom = UDim.new(0, 7)})
    local Content = New("Frame", {Parent = Main, Size = UDim2.new(1, -(Config.TabWidth or 180) - 24, 1,
         -60), Position = UDim2.fromOffset((Config.TabWidth
        or 180) + 16, 54), BackgroundTransparency = 1})
    local Window = {Tabs = {}, Gui = Gui, Current = nil}
    function Window:AddTab(TabConfig)
      local Index = #self.Tabs + 1
      local Button = New("TextButton", {Parent = Side, Size = UDim2.new(1, 0, 0, 35), BackgroundColor3 = Color3.fromRGB(55,

           30, 45), BorderSizePixel = 0, Text = TabConfig.Title or "Tab", TextColor3 = Color3.fromRGB(230,
                205, 218), TextSize = 13,
           Font = Enum.Font.Gotham, LayoutOrder = Index})
      Button.Visible = TabConfig.Hidden ~= true
      Round(Button, 6)
      local Page = New("ScrollingFrame", {Parent = Content, Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1,
           BorderSizePixel = 0,
           Visible = false, ScrollBarThickness = 4, AutomaticCanvasSize = Enum.AutomaticSize.Y, CanvasSize = UDim2.new()})
      New("UIListLayout", {Parent = Page, Padding = UDim.new(0, 7), SortOrder = Enum.SortOrder.LayoutOrder})
      New("UIPadding", {Parent = Page, PaddingTop = UDim.new(0, 4), PaddingLeft = UDim.new(0, 4), PaddingRight = UDim.new(0,

           8), PaddingBottom = UDim.new(0, 8)})
      local Tab = {Page = Page, Button = Button, ModuleKey = TabConfig.Module}
      local function Base(Text, Height)
        local Frame = New("Frame", {Parent = Page, Size = UDim2.new(1, 0, 0, Height or 42), BackgroundColor3 = Color3.fromRGB(48,

             31, 43), BorderSizePixel = 0})
        Round(Frame, 7)
        local Label = New("TextLabel", {Parent = Frame, Size = UDim2.new(1, -16, 1, 0), Position = UDim2.fromOffset(10,
             0),
             BackgroundTransparency = 1, Text = Text or "", TextColor3 = Color3.fromRGB(240, 225, 233),
                  TextSize = 13, Font = Enum.Font.Gotham,
             TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left})
        return Frame, Label
      end
      function Tab:AddSection(Text)
        local Frame, Label = Base(Text, 30)
        Frame.BackgroundTransparency = 1
        Label.TextColor3 = Color3.fromRGB(230, 105, 155)
        Label.Font = Enum.Font.GothamBold
        return Frame
      end
      function Tab:AddParagraph(Options)
        local Frame, Label = Base(Options.Title or "", 54)
        Label.Size = UDim2.new(1, -16, 0, 23)
        Label.Font = Enum.Font.GothamBold
        local Desc = New("TextLabel", {Parent = Frame, Size = UDim2.new(1, -16, 0, 25), Position = UDim2.fromOffset(10,
             24),
             BackgroundTransparency = 1, Text = Options.Content or "", TextColor3 = Color3.fromRGB(185,
                  170, 180), TextSize = 12,
             Font = Enum.Font.Gotham, TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left})
        local Control = {}
        function Control:SetDesc(Value)
            Desc.Text = tostring(Value or "") end
        function Control:SetTitle(Value)
            Label.Text = tostring(Value or "") end
        return Control
      end
      function Tab:AddButton(Options)
        local Frame = Base("", 40)
        local ButtonControl = New("TextButton", {Parent = Frame, Size = UDim2.new(1, -10, 1, -8), Position = UDim2.fromOffset(5,

             4), BackgroundColor3 = Color3.fromRGB(115, 40, 70), BorderSizePixel = 0, Text = Options.Title
                 or "Button", TextColor3 = Color3.new(1,
             1, 1), TextSize = 13, Font = Enum.Font.GothamBold})
        Round(ButtonControl, 6)
        local Name = Options.Title or "Button"
        _G.DragonHubActions[Name] = Options.Callback
        if _G.DragonPendingHubActions[Name] and Options.Callback then
          _G.DragonPendingHubActions[Name] = nil
          task.spawn(Options.Callback)
        end
        ButtonControl.MouseButton1Click:Connect(function()
            pcall(Options.Callback or function() end) end)
        return ButtonControl
      end
      function Tab:AddToggle(Id, Options)
        local Frame, Label = Base(Options.Title or Id, 42)
        local ButtonControl = New("TextButton", {Parent = Frame, Size = UDim2.fromOffset(54, 26), Position = UDim2.new(1,

             -62, 0.5, -13), BackgroundColor3 = Color3.fromRGB(75, 65, 72), BorderSizePixel = 0, Text = "OFF",
                  TextColor3 = Color3.new(1,
             1, 1), TextSize = 11, Font = Enum.Font.GothamBold})
        Round(ButtonControl, 13)
        Label.Size = UDim2.new(1, -78, 1, 0)
        local Control = {Value = Options.Default == true, Callback = Options.Callback}
        function Control:Render()
            ButtonControl.Text = self.Value and "ON" or "OFF"
            ButtonControl.BackgroundColor3 = self.Value and Color3.fromRGB(185, 55, 100) or Color3.fromRGB(75,
                 65, 72) end
        ...
        function Control:OnChanged(Callback)
          ...
          local Name = Options.Title or Id
          _G.DragonHubCallbacks[Name] = Callback
          local Pending = _G.DragonPendingHubValues[Name]
          if Pending ~= nil then
            self.Value = Pending
            _G.DragonPendingHubValues[Name] = nil
          end
          task.spawn(Callback, self.Value)
        end
        ButtonControl.MouseButton1Click:Connect(function()
            Control:SetValue(not Control.Value) end)
        Control:Render()
        return Control
      end
      function Tab:AddDropdown(Id, Options)
        ...
        local ButtonControl = New("TextButton", {Parent = Frame, Size = UDim2.new(0.43, 0, 0, 28), Position = UDim2.new(0.55,

             0, 0.5, -14), BackgroundColor3 = Color3.fromRGB(75, 45, 63), BorderSizePixel = 0, Text = tostring(Current
                 or "Select"),
             TextColor3 = Color3.new(1, 1, 1), TextSize = 11})
        Round(ButtonControl, 6)
        local Control = {Value = Current, Callback = Options.Callback, Index = 1, Values = Values}
        function Control:SetValue(Value)
            self.Value = Value ButtonControl.Text = tostring(Value or "Select")
            if self.Callback then task.spawn(self.Callback, Value) end end
function Control:OnChanged(Callback)
             local Name = Options.Title or Id self.Callback = Callback _G.DragonHubCallbacks[Name] = Callback _G.DragonHubControlInfo[Name] = {Type = "Dropdown",

                  Values = self.Values, Value = self.Value}
                 local Pending = _G.DragonPendingHubValues[Name] if Pending ~= nil then
                 self.Value = Pending _G.DragonPendingHubValues[Name] = nil
            end
...
if #Control.Values > 0 then
                 Control.Index = Control.Index % #Control.Values + 1 Control:SetValue(Control.Values[Control.Index])
            end
            end
            )
        return Control
      ...
      function Tab:AddSlider(Id, Options)
        ...
        local Track = New("Frame", {Parent = Frame, Size = UDim2.new(1, -24, 0, 6), Position = UDim2.new(0,
             12, 0, 36), BackgroundColor3 = Color3.fromRGB(65,
             65, 88), BorderSizePixel = 0})
        Round(Track, 3)
        local Fill = New("Frame", {Parent = Track, BackgroundColor3 = Color3.fromRGB(108, 79, 255), BorderSizePixel = 0})
        Round(Fill, 3)
        local Knob = New("Frame", {Parent = Track, Size = UDim2.fromOffset(16, 16), AnchorPoint = Vector2.new(0.5,
             0.5), BackgroundColor3 = Color3.fromRGB(255,
             255, 255), BorderSizePixel = 0, ZIndex = 4})
        Round(Knob, 8)
        local Hit = New("TextButton", {Parent = Track, Size = UDim2.new(1, 0, 4, 8), Position = UDim2.new(0,
             0, 0, -10), BackgroundTransparency = 1,
             Text = "", ZIndex = 5})
        local Dragging = false
        function Control:Render()
...
function Control:OnChanged(Callback)
             local Name = Options.Title or Id self.Callback = Callback _G.DragonHubCallbacks[Name] = Callback _G.DragonHubControlInfo[Name] = {Type = "Slider",

                  Min = Min, Max = Max, Value = self.Value}
                 local Pending = _G.DragonPendingHubValues[Name] if Pending ~= nil then
                 self.Value = math.clamp(tonumber(Pending) or self.Value, Min, Max)
                     _G.DragonPendingHubValues[Name] = nil
                     self:Render()
            end
             task.spawn(Callback, self.Value)
        ...
        local function Update(Input)
          ...
          local Ratio = math.clamp((Input.Position.X - Track.AbsolutePosition.X) / Track.AbsoluteSize.X,
               0, 1)
...
if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
      ...
      function Tab:AddInput(Id, Options)
        ...
        local Input = New("TextBox", {Parent = Frame, Size = UDim2.new(0.53, 0, 0, 28), Position = UDim2.new(0.45,
             0, 0.5,
             -14), BackgroundColor3 = Color3.fromRGB(75, 45, 63), BorderSizePixel = 0, Text = tostring(Options.Default
                 or ""),
             PlaceholderText = Options.Placeholder or "", TextColor3 = Color3.new(1, 1, 1), TextSize = 12,
                  ClearTextOnFocus = false})
        Round(Input, 6)
        Input.FocusLost:Connect(function()
            pcall(Options.Callback or function() end, Input.Text) end)
        return Input
      end
      Button.MouseButton1Click:Connect(function()
          Window:SelectTab(Index) end)
      table.insert(self.Tabs, Tab)
      if Index == 1 then self:SelectTab(1) end
      return Tab
    end
    function Window:SelectTab(Index)
      for Number, Tab in ipairs(self.Tabs) do
        Tab.Page.Visible = Number == Index
        Tab.Button.BackgroundColor3 = Number == Index and Color3.fromRGB(145, 45, 85) or Color3.fromRGB(55,
             30, 45)
      end
      self.Current = Index
    end
    local Key = Config.MinimizeKey or Enum.KeyCode.End
    game:GetService("UserInputService").InputBegan:Connect(function(Input, Processed)
        if not Processed and Input.KeyCode == Key then Gui.Enabled = not Gui.Enabled end end)
    return Window
  end
  return Library
end)()
_G.DragonUILibrary = DragonUILibrary
...
if not pcall(function()
    ScreenGui.Parent = CoreGui end) then ScreenGui.Parent = plr.PlayerGui end
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

local ToggleButton = Instance.new("TextButton")
ToggleButton.Size = UDim2.new(0, 50, 0, 50)
ToggleButton.Position = UDim2.new(0.15, 0, 0.15, 0)
ToggleButton.BackgroundColor3 = Color3.fromRGB(22, 24, 39)
ToggleButton.BorderSizePixel = 0
ToggleButton.Text = "D"
ToggleButton.TextColor3 = Color3.fromRGB(238, 240, 255)
...
local DragonUILibrary = _G.DragonUILibrary or {}

if not _G.DragonUILibrary then
function DragonUILibrary:CreateWindow()
  local Window = {}
  function Window:AddTab(TabConfig)
    local Tab = {ModuleKey = TabConfig and TabConfig.Module}
    function Tab:AddSection()
      return {}
    end
    function Tab:AddParagraph(Options)
      local Control = {Title = Options and Options.Title or "", Content = Options and Options.Content
          or ""}
      function Control:SetDesc(Value)
          self.Content = tostring(Value or "") end
      function Control:SetTitle(Value)
          self.Title = tostring(Value or "") end
      return Control
    end
    function Tab:AddButton(Options)
      local Name = Options and Options.Title or "Button"
      local Callback = Options and Options.Callback
      _G.DragonHubActions[Name] = Callback
      if _G.DragonPendingHubActions[Name] and Callback then
        _G.DragonPendingHubActions[Name] = nil
        task.spawn(function()
          local Success, Error = pcall(Callback)
          if not Success then _G.DragonHubFunctionError = Name .. ": " .. tostring(Error) end
        end)
      end
      return {}
    end
    function Tab:AddToggle(Id, Options)
      local Control = {Value = Options and Options.Default == true or false}
      function Control:OnChanged(Callback)
        self.Callback = Callback
        local Name = Options and Options.Title or Id
        _G.DragonHubCallbacks[Name] = Callback
        local Pending = _G.DragonPendingHubValues[Name]
        if Pending ~= nil then
          self.Value = Pending == true
          _G.DragonPendingHubValues[Name] = nil
        end
        _G.DragonHubControlInfo[Name] = {Type = "Toggle", Value = self.Value}
        task.spawn(function()
          local Success, Error = pcall(Callback, self.Value)
          if not Success then _G.DragonHubFunctionError = Name .. ": " .. tostring(Error) end
        end)
      end
      function Control:SetValue(Value)
      ...
      function Control:SetDesc() end
      function Control:SetTitle() end
      return Control
    end
    function Tab:AddDropdown(Id, Options)
      local Values = Options and Options.Values or {}
      local Value = Options and Options.Default or nil
      if type(Value) == "number" then Value = Values[Value] end
      if Value == nil then Value = Values[1] end
      local Name = Options and Options.Title or Id
      local Control = {Value = Value, Values = Values}
      function Control:OnChanged(Callback)
        self.Callback = Callback
        _G.DragonHubCallbacks[Name] = Callback
        local Pending = _G.DragonPendingHubValues[Name]
        ...
        _G.DragonHubControlInfo[Name] = {Type = "Dropdown", Values = self.Values, Value = self.Value}
        if self.Value ~= nil then pcall(Callback, self.Value) end
      end
      function Control:SetValue(NewValue)
        self.Value = NewValue
        _G.DragonHubControlInfo[Name] = {Type = "Dropdown", Values = self.Values, Value = self.Value}
        if self.Callback then pcall(self.Callback, NewValue) end
      end
    ...
    function Tab:AddSlider(Id, Options)
      local Control = {Value = Options and Options.Default or 0}
      function Control:OnChanged(Callback)
        self.Callback = Callback
        local Name = Options and Options.Title or Id
        _G.DragonHubCallbacks[Name] = Callback
        local Pending = _G.DragonPendingHubValues[Name]
        if Pending ~= nil then
          self.Value = tonumber(Pending) or self.Value
          _G.DragonPendingHubValues[Name] = nil
        end
        _G.DragonHubControlInfo[Name] = {Type = "Slider", Min = Options and Options.Min, Max = Options
            and Options.Max, Value = self.Value}
    ...
    function Tab:AddInput(Id, Options)
      local Control = {Value = Options and Options.Default or ""}
      local Name = Options and Options.Title or Id
      local InitialCallback = Options and Options.Callback
      if InitialCallback then
        Control.Callback = InitialCallback
        _G.DragonHubCallbacks[Name] = InitialCallback
        local Pending = _G.DragonPendingHubValues[Name]
        if Pending ~= nil then
          Control.Value = tostring(Pending)
          _G.DragonPendingHubValues[Name] = nil
        end
        _G.DragonHubControlInfo[Name] = {Type = "Input", Value = Control.Value}
      end
      function Control:OnChanged(Callback)
        self.Callback = Callback
        _G.DragonHubCallbacks[Name] = Callback
        local Pending = _G.DragonPendingHubValues[Name]
        if Pending ~= nil then
          self.Value = tostring(Pending)
          _G.DragonPendingHubValues[Name] = nil
        end
        _G.DragonHubControlInfo[Name] = {Type = "Input", Value = self.Value}
        pcall(Callback, self.Value)
      end
      function Control:SetValue(Value)
        self.Value = Value
...
local Window = DragonUILibrary:CreateWindow({Title = "DragonHUB | HUB | " .. tostring(_G.DragonDetectedWorld),
    TabWidth = 145,
    Size = UDim2.fromOffset(530, 360),MinimizeKey = Enum.KeyCode.End})

local Tabs = {
  Automatic = Window:AddTab({Title = "Automatic", Hidden = _G.DragonSelectedMode == "HUB"}),
  Settings = Window:AddTab({Title = "Setting Farm", Module = "Settings"}),
  Main = Window:AddTab({Title = "Farm", Module = "Farm"}),
  Melee = Window:AddTab({Title = "Fighting Style", Module = "Melee"}),
  Quests = Window:AddTab({Title = "Items Farm", Module = "Items"}),
  Valentine = Window:AddTab({Title = "Valentine", Module = "Events"}),
  SeaEvent = Window:AddTab({Title = "Sea Events", Hidden = not World3, Module = "Events"}),
  Mirage = Window:AddTab({Title = "Mirage + RaceV4", Hidden = not World3, Module = "Events"}),
  Drago = Window:AddTab({Title = "Drago Dojo", Hidden = not World3, Module = "Events"}),
  Prehistoric = Window:AddTab({Title = "Prehistoric", Hidden = not World3, Module = "Events"}),
  Raids = Window:AddTab({Title = "Raid", Hidden = World1, Module = "Raids"}),
  Combat = Window:AddTab({Title = "Combat PVP", Module = "Combat"}),
  Travel = Window:AddTab({Title = "Travel", Module = "Travel"}),
  Fruit = Window:AddTab({Title = "Fruits", Module = "Fruits"}),
  Shop = Window:AddTab({Title = "Shop", Module = "Shop"}),
...
local DragonQuestLastRequest = 0
local DragonQuestLastAbandon = 0
local DragonQuestExpectedKey = nil

local function CloseDragonQuestDialogue()
  local MainGui = plr.PlayerGui:FindFirstChild("Main")
  local Dialogue = MainGui and MainGui:FindFirstChild("Dialogue")
  if Dialogue and Dialogue.Visible then
    Dialogue.Visible = false
  end
end

local function ResetDragonQuestMovement(CurrentRoot)
  if CurrentRoot then
    CurrentRoot.AssemblyLinearVelocity = Vector3.zero
    CurrentRoot.AssemblyAngularVelocity = Vector3.zero
  end
  if block and block.Parent == workspace and CurrentRoot then
    block.CFrame = CurrentRoot.CFrame
  end
end

local function AbandonDragonQuest(CurrentRoot)
  if os.clock() - DragonQuestLastAbandon < 0.75 then return end
  DragonQuestLastAbandon = os.clock()
  CloseDragonQuestDialogue()
  replicated.Remotes.CommF_:InvokeServer("AbandonQuest")
  DragonQuestLastRequest = 0
  ResetDragonQuestMovement(CurrentRoot)
end
  ...
  while wait(Sec) do
	if _G.Level then
	  pcall(function()
	    ...
	    if not QuestData[1] or not QuestData[2] or not QuestData[3] or not QuestData[4] or not QuestData[5]
	        or not QuestData[6] then
	      _G.DragonHubFunctionError = "Missão não encontrada para o nível " .. tostring(plr.Data.Level.Value) .. " neste mundo"
	      return
	    end
	    ...
	    local ExpectedKey = tostring(QuestData[3]) .. ":" .. tostring(QuestData[2]) .. ":" .. tostring(QuestData[5])
	    if DragonQuestExpectedKey and DragonQuestExpectedKey ~= ExpectedKey then
	      DragonQuestExpectedKey = ExpectedKey
	      if QuestGui.Visible then
	        AbandonDragonQuest(CurrentRoot)
	      else
	        ResetDragonQuestMovement(CurrentRoot)
	      end
	      return
	    ...
	    if QuestGui.Visible == false then
	      CloseDragonQuestDialogue()
  	      _tp(QuestData[6] * CFrame.new(0, 0, 4))
	      if (CurrentRoot.Position - QuestData[6].Position).Magnitude <= 8 and os.clock() - DragonQuestLastRequest >= 1.5 then
	        DragonQuestLastRequest = os.clock()
	        CloseDragonQuestDialogue()
	        replicated.Remotes.CommF_:InvokeServer("StartQuest", QuestData[3], QuestData[2])
	      end
	    elseif not string.find(QuestTitle, QuestData[5], 1, true) then
	      AbandonDragonQuest(CurrentRoot)
	      ...
	      if workspace.Enemies:FindFirstChild(QuestData[1]) then
		    for i, v in pairs(workspace.Enemies:GetChildren()) do
		      if Attack.Alive(v) then
			    if v.Name == QuestData[1] then
			      if string.find(QuestTitle, QuestData[5], 1, true) then
				    repeat wait()
Attack.Kill(v, _G.Level)
		    ...
		    _tp(QuestData[4])
		    if replicated:FindFirstChild(QuestData[1]) then _tp(replicated:FindFirstChild(QuestData[1]).HumanoidRootPart.CFrame * CFrame.new(0,
      ...
      if _G.TravelDres then
        if plr.Data.Level.Value >= 700 then
          if workspace.Map.Ice.Door.CanCollide == true and workspace.Map.Ice.Door.Transparency == 0 then
		    ...
		    EquipWeapon("Key")
		    repeat wait()
		        _tp(CFrame.new(1347.7124, 37.3751602, -1325.6488)) until not _G.TravelDres or (Root.Position == CFrame.new(1347.7124,

		         37.3751602, -1325.6488).Position)
            ...
            if Enemies:FindFirstChild("Ice Admiral") then
              for _,xz in pairs(Enemies:GetChildren()) do
                if xz.Name == "Ice Admiral" and Attack.Alive(xz) then
              	  repeat task.wait()
              	      Attack.Kill(xz,_G.TravelDres) until _G.TravelDres == false or xz.Humanoid.Health <= 0
          ...
          if replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 3 then
            if replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess ~= nil then
              ...
              if replicated.Remotes.CommF_:InvokeServer("ZQuestProgress", "Check") == 0 then
                ...
                if v then
                  repeat wait()
                      Attack.Kill(v,_G.AutoZou) until not _G.AutoZou or not v.Parent or v.Humanoid.Health <= 0
                  Check = 2
                  repeat wait()
                      replicated.Remotes.CommF_:InvokeServer("F_","TravelZou")until Check == 1
                else
              ...
              elseif replicated.Remotes["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then
                ...
                if v then
                  ...
                  repeat wait()
                      _tp(CFrame.new(2288.802, 15.1870775, 863.034607)) until not _G.AutoZou or (Root.Position == CFrame.new(2288.802,

                       15.1870775, 863.034607).Position)
                  if (Root.CFrame == CFrame.new(2288.802, 15.1870775, 863.034607)) then notween(CFrame.new(2288.802,
                       15.1870775,
                       863.034607)) end
                end
              end
...
if string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,

     "50") and plr.PlayerGui.Main.Quest.Visible == true then
...
Attack.Kill(v,_G.AutoZou)
            ...
            elseif replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 1 then
              ...
              if v then
                repeat wait()
                    Attack.Kill(v,_G.AutoZou) until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoZou == false
              else
            ...
            elseif replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
              repeat wait()
                  _tp(CFrame.new(-1836, 11, 1714)) until not _G.AutoZou or (Root.Position == CFrame.new(-1836,
                       11, 1714).Position)
        ...
        for i,v in pairs(workspace.Enemies:GetChildren()) do
          if v:FindFirstChild("Humanoid") or v:FindFirstChild("HumanoidRootPart") then
            if v.Humanoid.Health > 0 then
              repeat wait()
                  Attack.Kill(v,_G.AutoFarmNear) until not _G.AutoFarmNear or not v.Parent or v.Humanoid.Health <= 0
            end
          end
        end
      end
...
spawn(function()
  while wait(Sec) do
    if _G.AutoRaidCastle then
      pcall(function()
      local CFrameCastleRaid = CFrame.new(-5496.17432, 313.768921, -2841.53027, 0.924894512, 7.37058015e-09,
           0.380223751,
        ...
        if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - Root.Position).Magnitude <= 500 then
            ...
            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
              if v.Name then
                if (v.HumanoidRootPart.Position - Root.Position).Magnitude <= 2000 then
                  repeat wait()
                      Attack.Kill(v,_G.AutoRaidCastle) until not _G.AutoRaidCastle or not v.Parent or v.Humanoid.Health <= 0
          ...
          local Castle_Mob = {"Galley Pirate","Galley Captain","Raider","Mercenary","Vampire","Zombie",
              "Snow Trooper","Winter Warrior",
              "Lab Subordinate","Horned Warrior","Magma Ninja","Lava Pirate","Ship Deckhand","Ship Engineer",
                  "Ship Steward",
...
spawn(function()
  local function processEnemy(v, EnemyName)
    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
      if v.Name == EnemyName then repeat wait()
          Attack.Kill(v,getgenv().AutoMaterial) until not getgenv().AutoMaterial or not v.Parent or v.Humanoid.Health <= 0 end
    end
  end
  ...
  while wait() do
    if getgenv().AutoMaterial then
      pcall(function()
        if getgenv().SelectMaterial then MaterialMon(getgenv().SelectMaterial)
            _tp(MPos) end
        for _, EnemyName in ipairs(MMon) do
  ...
  while wait(Sec) do
    pcall(function()
      if _G.AutoEctoplasm then
		...
		if Attack.Alive(v) then
		  repeat wait()
		      Attack.Kill(v, _G.AutoEctoplasm)until not _G.AutoEctoplasm or not v.Parent or v.Humanoid.Health <= 0
	    else
	      replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.21252441406, 126.9760055542,
	           32852.83203125))
	    end
      end
    end)
...
if not string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirate")then
                ...
                until _G.Bartilo_Quest == false or not x.Parent or x.Humanoid.Health <= 0 or Qbart.Visible == false
                    or not x:FindFirstChild("HumanoidRootPart")
              end
            else
              _tp(CFrame.nee(970.369446, 142.653198, 1217.3667, 0.162079468, -4.85452638e-08, -0.986777723,
                   1.03357589e-08,
                   1, -4.74980872e-08, 0.986777723, -2.50063148e-09, 0.162079468))
            end
          else
            repeat wait()
              _tp(CFrame.new(-461.533203, 72.3478546, 300.311096, 0.050853312, -0, -0.998706102, 0, 1,
                   -0, 0.998706102, 0,
                   0.050853312))
            until (CFrame.new(-461.533203, 72.3478546, 300.311096, 0.050853312, -0, -0.998706102, 0, 1,
                 -0, 0.998706102, 0,
                 0.050853312).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 20 or _G.Bartilo_Quest == false
if (CFrame.new(-461.533203, 72.3478546, 300.311096, 0.050853312, -0, -0.998706102, 0, 1, -0, 0.998706102,
     0, 0.050853312).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 1 then
          ...
          elseif replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 1 then
            ...
            if je then
              repeat task.wait()
                  Attack.Kill(je,_G.Bartilo_Quest) until _G.Bartilo_Quest == false or not je.Parent or je.Humanoid.Health <= 0
                  or Qbart.Visible == false or not je:FindFirstChild("HumanoidRootPart")
            else
              _tp(CFrame.new(2158.97412, 449.056244, 705.411682, -0.754199564, -4.17389057e-09, -0.656645238,
                   -4.47752875e-08,
                   1, 4.50709301e-08, 0.656645238, 6.3393955e-08, -0.754199564))
            end
          elseif replicated.Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
repeat
               wait()
                   _tp(CFrame.new(-1830.83972, 10.5578213, 1680.60229, 0.979988456, -2.02152783e-08, -0.199054286,
                        2.20792113e-08,
                    1, 7.1442483e-09, 0.199054286, -1.13962431e-08, 0.979988456))
          until (CFrame.new(-1830.83972, 10.5578213, 1680.60229, 0.979988456, -2.02152783e-08, -0.199054286,
               2.20792113e-08,
               1, 7.1442483e-09, 0.199054286, -1.13962431e-08, 0.979988456).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 1
              or _G.Bartilo_Quest == false
          wait(0.5)
    ...
    pcall(function()
      if _G.CitizenQuest then
        if Lv >= 1800 and replicated.Remotes.CommF_:InvokeServer("CitizenQuestProgress").KilledBandits == false then
          if string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Forest Pirate") and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,

               "50") and plr.PlayerGui.Main.Quest.Visible == true then
            local v = GetConnectionEnemies("Forest Pirate")
            if v then
              repeat task.wait()
                  Attack.Kill(v,_G.CitizenQuest)until _G.CitizenQuest == false or not v.Parent or v.Humanoid.Health <= 0
...
if (Vector3.new(-12443.8671875, 332.40396118164, -7675.4892578125) - plr.Character.HumanoidRootPart.Position).Magnitude <= 30 then
        ...
        elseif Lv >= 1800 and replicated.Remotes.CommF_:InvokeServer("CitizenQuestProgress").KilledBoss == false then
          ...
          if plr.PlayerGui.Main.Quest.Visible and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
               "Captain Elephant")
              and plr.PlayerGui.Main.Quest.Visible == true then
            if v then
              repeat task.wait()
                  Attack.Kill(v,_G.CitizenQuest) until _G.CitizenQuest == false or v.Humanoid.Health <= 0
                      or not v.Parent
                  or plr.PlayerGui.Main.Quest.Visible == false
            else
    ...
    if _G.DummyMan then
      pcall(function()
        if plr.PlayerGui.Main.Quest.Visible == false then
          ...
          if v then
		    repeat wait()
		        Attack.Kill(v,_G.DummyMan) until not _G.DummyMan or not v.Parent or v.Humanoid.Health <= 0
	      else
          ...
          for _, v in next, replicated.Remotes.CommF_:InvokeServer("getInventory") do
            if type(v) == "table" then
              if v.Type == "Sword" then
                ...
                if tonumber(v.Mastery) >= 1 or tonumber(v.Mastery) <= 599 then
                  ...
                  if GetBP(SwordName) then
		            if v then
                      repeat wait()
                          Attack.Sword(v,_G.FarmMastery_S) until _G.FarmMastery_S == false or not v.Parent
                              or v.Humanoid.Healh <= 0
		            else
		              _tp(CFrame.new(-1943.676513671875, 251.5095672607422, -12337.880859375))
		            end
                  else
              ...
              elseif tonumber(v.Mastery) >= 600 then
                if GetBP(SwordName) then return nil else replicated.Remotes.CommF_:InvokeServer("LoadItem",
                    SwordName) end
              end
                break
              end
    ...
    if _G.Auto_Cake_Prince then
      pcall(function()
        ...
        if bigMirror.Other.Transparency == 0 or enemies:FindFirstChild("Cake Prince") then
          ...
          if v then
            repeat wait()
                Attack.Kill2(v, _G.Auto_Cake_Prince)until not _G.Auto_Cake_Prince or not v.Parent or v.Humanoid.Health <= 0
          else
...
Attack.Kill(v, _G.Auto_Cake_Prince)
                until not _G.Auto_Cake_Prince or v.Humanoid.Health <= 0 or bigMirror.Other.Transparency == 0
      ...
      pcall(function()
        ...
        local bone = GetConnectionEnemies(BonesTable)
          if bone then
		    ...
		    repeat task.wait()
		        Attack.Kill(bone, _G.AutoFarm_Bone) until not _G.AutoFarm_Bone or bone.Humanoid.Health <= 0
		            or not bone.Parent
		        or (_G.AcceptQuestC and not questUI.Visible)
          else
            _tp(CFrame.new(-9495.6806640625, 453.58624267578125, 5977.3486328125))
  ...
  while wait(Sec) do
    if _G.AutoMiror then
      pcall(function()
        ...
        if v then
          repeat wait()
              Attack.Kill(v,_G.AutoMiror) until not _G.AutoMiror or not v.Parent or v.Humanoid.Health <= 0
        else
          _tp(CFrame.new(-1943.676513671875, 251.5095672607422, -12337.880859375))
        end
      end)
  ...
  while wait(Sec) do
    if _G.AutoHytHallow then
      pcall(function()
	    ...
	    if v then
          repeat task.wait()
              Attack.Kill(v,_G.AutoHytHallow) until v.Humanoid.Health <= 0 or _G.AutoHytHallow == false
        else
          if not GetBP("Hallow Essence") then
            repeat task.wait(.1)
                replicated.Remotes.CommF_:InvokeServer("Bones","Buy",1,1)until _G.AutoHytHallow == false
                    or GetBP("Hallow Essence")
          else
            repeat wait(.1)
_tp(CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125))
                until _G.AutoHytHallow == false or (plr.Character.HumanoidRootPart.CFrame == CFrame.new(-8932.322265625,
  ...
  while wait(Sec) do
    pcall(function()
      if _G.Auto_Random_Bone then
  	    repeat task.wait()
  	        replicated.Remotes.CommF_:InvokeServer("Bones","Buy",1,1) until not _G.Auto_Random_Bone
      end
    end)
  end
end)
...
repeat
		         wait()
		             _tp(CFrame.new(-2681.97998, 64.3921585, -12853.7363, 0.149007782, -1.87902192e-08, 0.98883605,
		                  3.60619588e-08,
		              1, 1.35681812e-08, -0.98883605, 3.36376011e-08, 0.149007782))
		    until not _G.Doughv2 or (plr.Character.HumanoidRootPart.CFrame - CFrame.new(-2681.97998, 64.3921585,
		         -12853.7363, 0.149007782,
		         -1.87902192e-08, 0.98883605, 3.60619588e-08, 1, 1.35681812e-08, -0.98883605, 3.36376011e-08,
		              0.149007782)).Magnitude <= 5
		    EquipWeapon("Red Key")
		  end
		  elseif GetConnectionEnemies("Dough King") then
            ...
            if v then
              repeat wait()
                  Attack.Kill(v,_G.Doughv2) until not _G.Doughv2 or not v.Parent or v.Humanoid.Health <= 0
            else
              _tp(CFrame.new(-1943.676513671875, 251.5095672607422, -12337.880859375))
            end
	      end
		  ...
		  local v = GetConnectionEnemies(cocoa3)
            if v then
            repeat wait()
                Attack.Kill(v,_G.Doughv2) until _G.Doughv2 == false or not v.Parent or v.Humanoid.Health <= 0
          else
  ...
  pcall(function()
    while wait(Sec) do
      if _G.Auto_Rainbow_Haki then
        if plr.PlayerGui.Main.Quest.Visible == false then
          if _G.GetQFast then
            if plr.PlayerGui.Main.Quest.Visible == false then replicated.Remotes.CommF_:InvokeServer("HornedMan",
                "Bet") end
          else
          ...
          elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,

               "Stone") then
            local v = GetConnectionEnemies("Stone")
            if v then
              repeat wait()
                  Attack.Kill(v,_G.Auto_Rainbow_Haki) until _G.Auto_Rainbow_Haki == false or v.Humanoid.Health <= 0
                      or not v.Parent
                  or plr.PlayerGui.Main.Quest.Visible == false
            else
              _tp(CFrame.new(-1086.11621, 38.8425903, 6768.71436, 0.0231462717, -0.592676699, 0.805107772,
                   2.03251839e-05,
          ...
          elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
            ...
            if v then
              ...
              replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5643.45263671875, 1013.0858154296875,
                   -340.51025390625))
          ...
          elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
            ...
            if v then
              ...
              _tp(CFrame.new(2877.61743, 423.558685, -7207.31006, -0.989591599, -0, -0.143904909, -0,
                   1.00000012, -0, 0.143904924,
                   0, -0.989591479))
            end
            elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,

                 "Captain Elephant") then
              local v = GetConnectionEnemies("Captain Elephant")
              if v then
                repeat task.wait()
                    Attack.Kill(v,_G.Auto_Rainbow_Haki)until _G.Auto_Rainbow_Haki == false or v.Humanoid.Health <= 0
              ...
              if (plr.Character.HumanoidRootPart.CFrame.Position ~= gamergayror1) then
                replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875,
        ...
        elseif plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
          ...
          if v then
            ...
            replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5314.54638671875, 22.562219619750977,
                 -127.06755065917969))
          end
        end
      end
      ...
      if _G.obsFarm then
        if World1 then
          if workspace.Enemies:FindFirstChild("Galley Captain") then
            if KenTest then
              repeat wait()
                plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild("Galley Captain").HumanoidRootPart.CFrame * CFrame.new(3,

                    0,0)
              until _G.obsFarm == false or KenTest == false
            else
              repeat wait()
                plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild("Galley Captain").HumanoidRootPart.CFrame * CFrame.new(0,
        ...
        elseif World2 then
          if workspace.Enemies:FindFirstChild("Lava Pirate") then
            if KenTest then
              repeat wait()
                plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild("Lava Pirate").HumanoidRootPart.CFrame * CFrame.new(3,

                    0,0)
              until _G.obsFarm == false or KenTest == false
            else
              repeat wait()
                plr.Character.HumanoidRootPart.CFrame = workspace.Enemies:FindFirstChild("Lava Pirate").HumanoidRootPart.CFrame * CFrame.new(0,
        ...
        elseif World3 then
          if workspace.Enemies:FindFirstChild("Venomous Assailant") then
            if KenTest then
              repeat wait()
                _tp(workspace.Enemies:FindFirstChild("Venomous Assailant").HumanoidRootPart.CFrame * CFrame.new(3,
                    0,0))
              until _G.obsFarm == false or KenTest == false
            else
              repeat wait()
                _tp(workspace.Enemies:FindFirstChild("Venomous Assailant").HumanoidRootPart.CFrame * CFrame.new(0,
                    50,0))
              until _G.obsFarm == false or KenTest
            end
          else
...
if plr.PlayerGui.Main.Quest.Visible == true and string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,
    "Defeat 50 Forest Pirates") then
	    local v = GetConnectionEnemies("Forest Pirate")
        if v then
	      repeat wait()
	          Attack.Kill(v,_G.AutoKenVTWO) until not _G.AutoKenVTWO or v.Humanoid.Health <= 0 or plr.PlayerGui.Main.Quest.Visible == false
	    else
	      _tp(Kv2Pos4)
	    end
	  ...
	  if not GetBP("Fruit Bowl") then
	    if not GetBP("Apple") then
	      replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203,
	           -7551.677734375))
	    ...
	    if plr.Backpack:FindFirstChild("Banana") and plr.Backpack:FindFirstChild("Apple") and plr.Backpack:FindFirstChild("Pineapple")
	      ...
	      repeat wait()
	          _tp(Kv2Pos1) until _G.AutoKenVTWO or plr.Character.HumanoidRootPart.CFrame == Kv2Pos1
		  replicated.Remotes.CommF_:InvokeServer("CitizenQuestProgress","Citizen")
	    end
        ...
        if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= 2 then
          ...
          elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
            ...
            elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
              local v = GetConnectionEnemies("Swan Pirate")
              if v then repeat wait()
                  Attack.Kill(v,_G.Auto_Mink) until GetBP("Flower 3") or not v.Parent or v.Humanoid.Health <= 0
                      or _G.Auto_Mink == false
      ...
      if _G.Auto_Human then
		...
		elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
		  ...
		  elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
		    local v = GetConnectionEnemies("Swan Pirate")
            if v then repeat wait()
                Attack.Kill(v,_G.Auto_Human) until plr.Backpack:FindFirstChild("Flower 3") or not v.Parent
                    or v.Humanoid.Health <= 0
                or _G.Auto_Human == false
		    else _tp(CFrame.new(980.0985107421875, 121.331298828125, 1287.2093505859375))end
		  end
		  elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 2 then
		    replicated.Remotes.CommF_:InvokeServer("Alchemist","3")
          ...
          if v then repeat wait()
              Attack.Kill(v,_G.Auto_Human)until v.Humanoid.Health <= 0 or not v.Parent or not _G.Auto_Human
        ...
        if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
		  ...
		  elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
		    ...
		    elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
		      ...
		      if v then
			    repeat wait()
			        Attack.Kill(v,_G.Auto_Skypiea)until plr.Backpack:FindFirstChild("Flower 3") or not v.Parent
			            or v.Humanoid.Health <= 0
			        or _G.Auto_Skypiea == false
		      else
	    ...
	    elseif replicated.Remotes.CommF_:InvokeServer("Wenlocktoad","1") == 1 then
	      for i,v in pairs(game.Players:GetChildren()) do
            if v.Name ~= plr.Name and tostring(v.Data.Race.Value) == "Skypiea" then
		      repeat task.wait()
		          _tp(v.HumanoidRootPart.CFrame * CFrame.new(0,8,0) * CFrame.Angles(math.rad(-45),0,0))until v.Humanoid.Health <= 0
		          or _G.Auto_Skypiea == false
	        end
	      end
        end
        ...
        if replicated.Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
		  ...
		  elseif replicated.Remotes.CommF_:InvokeServer("Alchemist","1") == 1 then
	        ...
	        elseif not plr.Backpack:FindFirstChild("Flower 3") and not plr.Character:FindFirstChild("Flower 3") then
		      ...
		      if v then
			    repeat wait()
			        Attack.Kill(v,_G.Auto_Fish)until plr.Backpack:FindFirstChild("Flower 3") or not v.Parent or v.Humanoid.Health <= 0
			        or _G.Auto_Fish == false
	          else
		       _tp(CFrame.new(980.0985107421875, 121.331298828125, 1287.2093505859375))
	          end
            end
    ...
    pcall(function()
      if _G.AutoRipIngay then
	    ...
	    if not GetWP("Dark Dagger") or not GetIn("Valkyrie") and v then
	      repeat wait()
	          Attack.Kill(v,_G.AutoRipIngay)until not _G.AutoRipIngay or not v.Parent or v.Humanoid.Health <= 0
        else
          replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5097.93164, 316.447021,
               -3142.66602, -0.405007899,
               -4.31682743e-08, 0.914313197, -1.90943332e-08, 1, 3.8755779e-08, -0.914313197, -1.76180437e-09,
                    -0.405007899))
		  wait(.1)
          ...
          for i,v in pairs(Summoner:FindFirstChild("Circle"):GetChildren()) do
            ...
            local TogglesPart = v:FindFirstChild("Part");
              if VaildColor(TogglesPart) == false then
                ...
                repeat wait()
                    _tp(v.CFrame) until VaildColor(TogglesPart) == true or not _G.AutoUnHaki;
              end
            end
          end
        end
  ...
  while task.wait(Sec) do
    pcall(function()
	  if _G.Safemode then
  	  ...
  	  if Calc_Health < Num_self then shouldTween=true
  	      _tp(Root.CFrame * CFrame.new(0,500,0)) else shouldTween=false end
      end
    end)
  end
end)
	  ...
	  local M_Frag = plr.Data.Fragments.Value
        if plr:FindFirstChild("WeaponAssetCache") then
          if not GetBP("Superhuman") then
            ...
            elseif GetBP("Black Leg") and GetBP("Black Leg").Level.Value < 299 then _G.Level = true elseif GetBP("Black Leg")
                and GetBP("Black Leg").Level.Value >= 300 then _G.Level = false end
            ...
            elseif GetBP("Fishman Karate") and GetBP("Fishman Karate").Level.Value < 299 then _G.Level = true elseif GetBP("Fishman Karate")
                and GetBP("Fishman Karate").Level.Value >= 300 then _G.Level = false end
            if not GetBP("Dragon Claw") then
            if (M_Frag >= 1500) then replicated.Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw",
                "2") end
            elseif GetBP("Dragon Claw") and GetBP("Dragon Claw").Level.Value < 299 then _G.Level = true elseif GetBP("Dragon Claw")
                and GetBP("Dragon Claw").Level.Value >= 300 then _G.Level = false end
...
if GetBP("Library Key") then
                  ...
                  until not _G.AutoDeathStep or (Root.Position == CFrame.new(6371.2001953125, 296.63433837890625,
...
if (Root.CFrame == CFrame.new(6371.2001953125, 296.63433837890625, -6841.18115234375)) then
		        ...
		        elseif not GetBP("Library Key") then
		          ...
		          if v then	repeat wait()
		              Attack.Kill(v,_G.AutoDeathStep) until not v.Parent or v.Humanoid.Health <= 0 or _G.AutoDeathStep == false
		              or GetBP("Library Key") or GetBP("Death Step")
...
repeat
			             wait()
			                 _tp(CFrame.new(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413,
			                      0, 1, 0, 0.999093413,
			                  0, 0.0425701365))
			        until not _G.Auto_SharkMan_Karate or (Root.Position == CFrame.new(-2604.6958, 239.432526, -10315.1982,
			             0.0425701365,
			             0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365).Position)
	                replicated.Remotes.CommF_:InvokeServer("BuySharkmanKarate")
		          end
		        end
		      elseif not GetBP("Water Key") then
		        ...
		        if v then repeat wait()
		            Attack.Kill(v,_G.Auto_SharkMan_Karate)until not v.Parent or v.Humanoid.Health <= 0 or _G.Auto_SharkMan_Karate == false
		            or GetBP("Water Key") or GetBP("Sharkman Karate")
      ...
      pcall(function()
        ...
        if not GetBP("Electro") then replicated.Remotes.CommF_:InvokeServer("BuyElectro") end
          if GetBP("Electro") and GetBP("Electro").Level.Value >= 400 then
            if replicated.Remotes.CommF_:InvokeServer("BuyElectricClaw", "Start") == nil then notween(CFrame.new(-12548,
                 337,
                 -7481)) end
            replicated.Remotes.CommF_:InvokeServer("BuyElectricClaw")
          elseif GetBP("Electro") and GetBP("Electro").Level.Value < 400 then
            repeat _G.AutoFarm_Bone = true
                wait() until not _G.Auto_Electric_Claw or GetBP("Electric Claw")
...
spawn(function()
  while wait(Sec) do
    if _G.AutoDragonTalon then
      pcall(function()
        if plr:FindFirstChild("WeaponAssetCache") then
        if not GetBP("Dragon Claw") then replicated.Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw",
            "2") end
          if GetBP("Dragon Claw") and GetBP("Dragon Claw").Level.Value >= 400 then replicated.Remotes.CommF_:InvokeServer("Bones",

              "Buy",1,1)
              replicated.Remotes.CommF_:InvokeServer("BuyDragonTalon")
          elseif GetBP("Dragon Claw") and GetBP("Dragon Claw").Level.Value < 400 then repeat _G.AutoFarm_Bone = true
              wait() until not _G.AutoDragonTalon or GetBP("Dragon Talon")
              _G.AutoFarm_Bone = false
          end
        end
      end)
    ...
    if _G.snaguine then
      pcall(function()
        ...
        if not GetBP("Sanguine Art") then
          ...
          if World3 then _G.DangerSc = "Lv Infinite"
              _G.SailBoats = true; else _G.SailBoats = false; end end
          if GetM("Vampire Fang") <= 19 then
            if World2 then
              local n = GetConnectionEnemies("Vampire")
              if n then repeat task.wait()
                  Attack.Kill(n,_G.snaguine) until not _G.snaguine or n.Humanoid.Health <= 0 or not n.Parent
          ...
          if GetM("Vampire Fang") >= 20 and GetM("Demonic Wisp") <= 19 then
           ...
           if GetM("Vampire Fang") >= 20 and GetM("Demonic Wisp") >= 20 and GetM("Dark Fragment") <= 1 then
             if World2 then
		       ...
		       if n then repeat task.wait()
		           Attack.Kill(black,_G.snaguine) until _G.snaguine or black.Humanoid.Health <= 0 or not black.Parent
...
if string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Diablo") or string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,

     "Urban") or string.find(plr.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Deandre") then
		    for i,v in pairs(replicated:GetChildren()) do
	 	    ...
	 	    for i,v in pairs(Enemies:GetChildren()) do
		      if (string.find(v.Name,"Diablo") or string.find(v.Name,"Urban") or string.find(v.Name,"Deandre"))
		          and Attack.Alive(v) then
	            repeat wait()
	                Attack.Kill(v, _G.FarmEliteHunt) until not _G.FarmEliteHunt or plr.PlayerGui.Main.Quest.Visible == false
...
_tp(CFrame.new(-13489, 332, -7925))
          ...
          if v then repeat task.wait()
              Attack.Kill(v,_G.Auto_Tushita) until v.Humanoid.Health <= 0 or not _G.Auto_Tushita or not v.Parent
          else
          if replicated:FindFirstChild("Longma") then _tp(replicated:FindFirstChild("Longma").HumanoidRootPart.CFrame * CFrame.new(0,
      ...
      if _G.Auto_Yama then
	    ...
	    elseif replicated.Remotes.CommF_:InvokeServer("EliteHunter", "Progress") > 30 then
	      ...
	      if (workspace.Map.Waterfall.SealedKatana.Handle.Position-plr.Character.HumanoidRootPart.Position).Magnitude >= 20 then
            ...
            if zx then
              repeat wait()
                  Attack.Kill(zx,_G.Auto_Yama) until zx.Humanoid.Health <= 0 or not zx.Parent or not _G.Auto_Yama
        ...
        if tostring(replicated.Remotes.CommF_:InvokeServer("CDKQuest", "OpenDoor")) ~= "opened" then
          ...
          elseif replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Finished"] == false then
            if tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Evil"]) == -3 then
              ...
              until tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Evil"]) == 1
                  or not _G.CDK_YM
                ...
                for NameMonHaze, CFramePos in pairs(PosMsList) do
                  if string.find(NameMonHaze,HitMon.Name) and HitMon.Value > 0 then
                    if (CFramePos.Position - Root.Position).Magnitude <= 1000 and workspace.Enemies:FindFirstChild(NameMonHaze) then
                      for i,v in pairs(workspace.Enemies:GetChildren()) do
                        if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0
                            and v:FindFirstChild("HazeESP") then
                          repeat wait()
                              Attack.Kill(v, _G.CDK_YM) until not _G.CDK_YM or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",

                              "Progress")["Evil"]) == 2 or not v:FindFirstChild("HazeESP") or v.Humanoid.Health <= 0
                        end
                      end
                    else
                      _tp(CFramePos)
...
Root.CFrame = workspace.Map.HellDimension.Exit.CFrame
                          until not _G.CDK_YM or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                  ...
                  repeat task.wait()
                    ...
                    wait(2)
                        _G.T1Yama = true
                  until not _G.CDK_YM or _G.T1Yama or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                      "Progress")["Evil"]) == 3
                  repeat task.wait()
                    repeat task.wait()
                  ...
                  until _G.T2Yama or _G.CDK_YM == false or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                      "Progress")["Evil"]) == 3
                    repeat wait()
                      repeat task.wait()
                    ...
                    until _G.T3Yama or _G.CDK_YM == false or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                        "Progress")["Evil"]) == 3
                  end
                  for i,v in pairs(workspace.Enemies:GetChildren()) do
...
Attack.Kill(v,_G.CDK_YM)
                            until not _G.CDK_YM or v.Humanoid.Health <= 0 or not v.Parent or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
...
if v then
                 repeat
                     task.wait()
                         _tp(v.HumanoidRootPart.CFrame)
                until v.Humanoid.Health <= 0 or not _G.CDK_YM or not v.Parent or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",

                    "Progress")["Evil"]) == 3 or (workspace.Map:FindFirstChild("HellDimension") and (Root.Position - workspace.Map.HellDimension.Spawn.Position).Magnitude <= 1000)
            elseif plr.Backpack:FindFirstChild("Hallow Essence") or plr.Character:FindFirstChild("Hallow Essence") then
            repeat _tp(CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125))
                task.wait() until (CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125).Position - Root.Position).Magnitude <= 8
            EquipWeapon("Hallow Essence")
...
if replicated.Remotes.CommF_:InvokeServer("Bones","Check") < 50 and not workspace.Enemies:FindFirstChild("Soul Reaper")
    and not replicated:FindFirstChild("Soul Reaper")
    and not workspace.Map:FindFirstChild("HellDimension") then
                if workspace.Enemies:FindFirstChild("Reborn Skeleton") or workspace.Enemies:FindFirstChild("Living Zombie")
                    or workspace.Enemies:FindFirstChild("Domenic Soul") or workspace.Enemies:FindFirstChild("Posessed Mummy") then
                  for i,v in pairs(workspace.Enemies:GetChildren()) do
if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 then
                        repeat task.wait()
                            Attack.Kill(v,_G.CDK_YM)until not _G.CDK_YM or v.Humanoid.Health <= 0 or not v.Parent
                      end
                    end
                  end
                else
...
repeat
              ...
              until (CFrame.new(-4602.5107421875, 16.446542739868164, -2880.998046875).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3
                  or not _G.CDK_TS or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Good"]) == 1
...
wait(1)
    repeat
                ...
                until (CFrame.new(4001.185302734375, 10.089399337768555, -2654.86328125).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3
                    or not _G.CDK_TS or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Good"]) == 1
...
wait(1)
    repeat
                  ...
                  until (CFrame.new(-9530.763671875, 7.245208740234375, -8375.5087890625).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3
                      or not _G.CDK_TS or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                          "Progress")["Good"]) == 1
if (CFrame.new(-9530.763671875, 7.245208740234375, -8375.5087890625).Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                  ...
                  elseif tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Good"]) == -4 then
                    ...
                    until not _G.CDK_TS or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                        "Progress")["Good"]) == 2
                  ...
                  elseif tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest","Progress")["Good"]) == -5 then
                    ...
                    if workspace.Enemies:FindFirstChild("Cake Queen") then
                      for i,v in pairs(workspace.Enemies:GetChildren()) do
                        if v.Name == "Cake Queen" then
                          if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            ...
                            until not _G.CDK_TS or not v.Parent or v.Humanoid.Health <= 0 or tonumber(replicated.Remotes.CommF_:InvokeServer("CDKQuest",
                     ...
                     elseif replicated:FindFirstChild("Cake Queen") and replicated:FindFirstChild("Cake Queen").Humanoid.Health > 0 then
                       _tp(replicated:FindFirstChild("Cake Queen").HumanoidRootPart.CFrame * CFrame.new(0,
                           30,0))
                     else
if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - workspace.Map.HeavenlyDimension.Spawn.Position).Magnitude <= 1000 then
                  ...
                  for i,v in pairs(workspace.Enemies:GetChildren()) do
if (v:FindFirstChild("HumanoidRootPart").Position - CFrame.new(-22695.7012, 5270.93652, 3814.42847, 0.11794927,
     3.32185834e-08,
     0.99301964, -8.73070718e-08, 1, -2.30819008e-08, -0.99301964, -8.3975138e-08, 0.11794927).Position).Magnitude <= 300 then
if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 then
                        repeat wait()
                          Attack.Kill(v, _G.CDK_TS)
  ...
  while wait(Sec) do
    if _G.AutoPole then
      pcall(function()
	    ...
	    if v then
          repeat task.wait()
              Attack.Kill(v, _G.AutoPole) until not _G.AutoPole or not v.Parent or v.Humanoid.Health <= 0
        else
  ...
  while wait(Sec) do
    pcall(function()
      if _G.AutoPoleV2 then
	   ...
	   if GetBP("Pole (1st Form)") and GetBP("Pole (1st Form)").Level.Value <= 179 then _G.Level = true elseif GetBP("Pole (1st Form)")
	       and GetBP("Pole (1st Form)").Level.Value >= 180 then _G.Level = false end
	   if not GetBP("Rumble Fruit") then return end
if GetBP("Rumble Fruit").AwakenedMoves:FindFirstChild("Z") and GetBP("Rumble Fruit").AwakenedMoves:FindFirstChild("X")
    and GetBP("Rumble Fruit").AwakenedMoves:FindFirstChild("C")
    and GetBP("Rumble Fruit").AwakenedMoves:FindFirstChild("V") and GetBP("Rumble Fruit").AwakenedMoves:FindFirstChild("F") then
	     _G.SelectChip = nil
		 _G.Raiding = false
        ...
        elseif replicated.Remotes.CommF_:InvokeServer("Awakener","Check") == nil or replicated.Remotes.CommF_:InvokeServer("Awakener",
  ...
  while wait(Sec) do
    if _G.AutoLawKak then
      pcall(function()
        ...
        if v then repeat task.wait()
            Attack.Kill(v, _G.AutoLawKak) until _G.AutoLawKak == false or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(.2) do
    pcall(function()
      if _G.AutoSaw then
        ...
        if v then repeat task.wait()
            Attack.Kill(v, _G.AutoSaw)until _G.AutoSaw == false or v.Humanoid.Health <= 0
...
if (CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08,
     1, 1.91679348e-08,
     0.928667724, -4.39869794e-08, 0.37091279).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 100 then
		      ...
		      _tp(CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08,
		           1, 1.91679348e-08,
		    ...
		    if workspace.Map.Desert.Burn.Part.Transparency == 0 then
		      if plr.Backpack:FindFirstChild("Torch") or plr.Character:FindFirstChild("Torch") then
			    ...
			    firetouchinterest(plr.Character.Torch.Handle,workspace.Map.Desert.Burn.Fire,1)
		   	    _tp(CFrame.new(1114.61475, 5.04679728, 4350.22803, -0.648466587, -1.28799094e-09, 0.761243105,
		   	         -5.70652914e-10,
		   	         1, 1.20584542e-09, -0.761243105, 3.47544882e-10, -0.648466587))
		      else
		        _tp(CFrame.new(-1610.00757, 11.5049858, 164.001587, 0.984807551, -0.167722285, -0.0449818149,
		             0.17364943, 0.951244235,
		             0.254912198, 3.42372805e-05, -0.258850515, 0.965917408))                    end
		      else
		        if replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","SickMan") ~= 0 then
		          ...
		          elseif replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon") == 0 then
			        if workspace.Enemies:FindFirstChild("Mob Leader") or replicated:FindFirstChild("Mob Leader") then
			          _tp(CFrame.new(-2967.59521, -4.91089821, 5328.70703, 0.342208564, -0.0227849055, 0.939347804,
			               0.0251603816, 0.999569714,
			               0.0150796166, -0.939287126, 0.0184739735, 0.342634559))
			         for i,v in pairs(workspace.Enemies:GetChildren()) do
				       if v.Name == "Mob Leader" and Attack.Alive(v) then
				       repeat task.wait()
				           Attack.Kill(v, _G.AutoSaber)until v.Humanoid.Health <= 0 or _G.AutoSaber == false
				       end
				     end
			       end
			     elseif replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon") == 1 then
			       replicated.Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon")
				   EquipWeapon("Relic")
				  _tp(CFrame.new(-1404.91504, 29.9773273, 3.80598116, 0.876514494, 5.66906877e-09, 0.481375456, 2.53851997e-08,
				       1, -5.79995607e-08,
	     ...
	     if workspace.Enemies:FindFirstChild("Saber Expert") or replicated:FindFirstChild("Saber Expert") then
	       for _,v in pairs(workspace.Enemies:GetChildren()) do
		    ...
		    _tp(CFrame.new(-1401.85046, 29.9773273, 8.81916237, 0.85820812, 8.76083845e-08, 0.513301849, -8.55007443e-08,
		         1, -2.77243419e-08,
		         -0.513301849, -2.00944328e-08, 0.85820812))
	      end
	    end
      end
    end)
  ...
  while wait(.2) do
    if _G.AutoColShad then
      pcall(function()
	    ...
	    if v then repeat task.wait()
	        Attack.Kill(v, _G.AutoColShad)until _G.AutoColShad == false or not v.Parent or v.Humanoid.Health <= 0
...
repeat
              ...
              until _G.AutoGetUsoap == false or v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart")
    ...
    if _G.Greybeard then
      pcall(function()
        ...
        elseif GetWP("Bisento") then
          ...
          if v then repeat wait()
              Attack.Kill(v,_G.Greybeard)until _G.Greybeard == false or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(.1) do
    if _G.WardenBoss then
      pcall(function()
        ...
        if v then repeat wait()
            Attack.Kill(v,_G.WardenBoss) until _G.WardenBoss == false or not v.Parent or v.Humanoid.Health <= 0
        else _tp(CFrame.new(5206.92578,0.997753382,814.976746,0.342041343,-0.00062915677,0.939684749,
            0.00191645394,0.999998152,
            -2.80422337e-05,-0.939682961,0.00181045406,0.342041939))
        end
      end)
  ...
  while wait(.1) do
    if _G.MarinesCoat then
      pcall(function()
        ...
        if v then repeat wait()
            Attack.Kill(v, _G.MarinesCoat) until _G.MarinesCoat == false or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(.1) do
    if _G.SwanCoat then
      pcall(function()
        ...
        if v then repeat wait()
            Attack.Kill(v, _G.SwanCoat)until _G.SwanCoat == false or not v.Parent or v.Humanoid.Health <= 0
        else _tp(CFrame.new(5325.09619, 7.03906584, 719.570679, -0.309060812, 0, 0.951042235, 0, 1, 0,
  ...
  pcall(function()
    while wait(.1) do
      if _G.IceBossRen then
        local v = GetConnectionEnemies("Awakened Ice Admiral")
        if v then repeat task.wait()
            Attack.Kill(v,_G.IceBossRen)until _G.IceBossRen == false or not v.Parent or v.Humanoid.Health <= 0
        else _tp(CFrame.new(5668.9780273438, 28.519989013672, -6483.3520507813))
        end
      end
    end
    ...
    pcall(function()
      if _G.KeysRen then
        if plr.Backpack:FindFirstChild(RenMon[3]) or plr.Character:FindFirstChild(RenMon[3]) then
          ...
          if v then repeat task.wait()
              Attack.Kill(v,_G.KeysRen)until plr.Backpack:FindFirstChild(RenMon[3]) or _G.KeysRen == false
                  or not v.Parent
              or v.Humanoid.Health <= 0
  ...
  while wait(.1) do
    pcall(function()
      if _G.AutoTridentW2 then
        local v = GetConnectionEnemies("Tide Keeper")
        if v then repeat task.wait()
            Attack.Kill(v,_G.AutoTridentW2)until _G.AutoTridentW2 == false or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(.1) do
    pcall(function()
      if _G.LongsWord then
        ...
        if v then repeat task.wait()
            Attack.Kill(v,_G.LongsWord)until _G.LongsWord == false or not v.Parent or v.Humanoid.Health <= 0
        else _tp(CFrame.new(-1576.7166748047, 198.59265136719, 13.724286079407))
        end
      end
    end)
  ...
  while wait(.1) do
    if _G.BlackSpikey then
      pcall(function()
        local v = GetConnectionEnemies("Jeremy")
        if v then repeat wait()
            Attack.Kill(v, _G.BlackSpikey)until _G.BlackSpikey == false or not v.Parent or v.Humanoid.Health <= 0
        else _tp(CFrame.new(2006.9261474609, 448.95666503906, 853.98284912109))
        end
      end)
    end
...
_tp(CFrame.new(-5719.36376953125, 48.50590515136719, -782.9759521484375))
                until not _G.DarkBladev3 or (Root.Position == CFrame.new(-5719.36376953125,
                 48.50590515136719, -782.9759521484375).Position)
    ...
    pcall(function()
      if _G.AutoEcBoss then
	    ...
	    elseif GetM("Ectoplasm") <= 99 then
	      ...
	      if v then repeat wait()
	          Attack.Kill(v, _G.AutoEcBoss) until not _G.AutoEcBoss or not v.Parent or v.Humanoid.Health <= 0
	      else
	        replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.21252441406, 126.9760055542,
	             32852.83203125))
	            wait(.5)
    ...
    if _G.Auto_Def_DarkCoat then
      pcall(function()
        ...
        elseif GetConnectionEnemies("Darkbeard") then
		  ...
		  if v then repeat wait()
		      Attack.Kill(v,_G.Auto_Def_DarkCoat)until _G.Auto_Def_DarkCoat == false or not v.Parent or v.Humanoid.Helath <= 0 end
        elseif not GetBP("Fist of Darkness") and not GetConnectionEnemies("Darkbeard") then
          repeat wait(.1)
              _G.AutoFarmChest = true until not _G.Auto_Def_DarkCoat or GetBP("Fist of Darkness") or GetConnectionEnemies("Darkbeard")
              _G.AutoFarmChest = false
        end
      end)
    end
  ...
  while wait(.2) do
    if _G.Auto_SwanGG then
      pcall(function()
        local v = GetConnectionEnemies("Don Swan")
        if v then repeat wait()
            Attack.Kill(v,_G.Auto_SwanGG)until _G.Auto_SwanGG == false or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(Sec) do
    if _G.AutoBigmom then
      pcall(function()
        ...
        if bx then repeat task.wait()
            Attack.Kill(bx, _G.AutoBigmom) until not _G.AutoBigmom or not bx.Parent or bx.Humanoid.Health <= 0
  ...
  while wait(Sec) do
    pcall(function()
      if _G.Auto_Cavender then
	    ...
	    if v then repeat wait()
	        Attack.Kill(v,_G.Auto_Cavender)until not _G.Auto_Cavender or v.Humanoid.Health <= 0
  ...
  while wait(Sec) do
    pcall(function()
      if _G.TwinHook then
        local v = GetConnectionEnemies("Captain Elephant")
	    if v then repeat wait()
	        Attack.Kill(v,_G.TwinHook)until not _G.TwinHook or v.Humanoid.Health <= 0
	    else
          replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203,
               -7551.677734375))
              wait(.2)
...
spawn(function()
  while wait(Sec) do
    if _G.AutoSerpentBow then
      local v = GetConnectionEnemies("Hydra Leader")
      if v then	repeat wait()
          Attack.Kill(v,_G.AutoSerpentBow)until not _G.AutoSerpentBow or not v.Parent or v.Humanoid.Health <= 0
  ...
  while wait(.2) do
    if _G.AutoKilo then
      pcall(function()
        local v = GetConnectionEnemies("Kilo Admiral")
        if v then repeat task.wait()
            Attack.Kill(v,_G.AutoKilo)until not _G.AutoKilo or not v.Parent or v.Humanoid.Health <= 0
...
if (buyBoatCFrame.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                 replicated.Remotes.CommF_:InvokeServer("BuyBoat",
                 _G.SelectedBoat) end
          else
            if plr.Character.Humanoid.Sit == false then
              ...
              until not _G.FindMirage or (targetDestination.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10
                  or workspace["_WorldOrigin"].Locations:FindFirstChild("Mirage Island") or plr.Character.Humanoid.Sit == false
...
if workspace["_WorldOrigin"].Locations:FindFirstChild("Mirage Island",true) then
           _tp(workspace.Map.MysticIsland.Center.CFrame*CFrame.new(0,
          400,0))end
      end)
    end
  end
  ...
  while wait(Sec) do
    pcall(function()
      if _G.Auto_Soul_Guitar then
        if World3 then
          ...
          if replicated.Remotes.CommF_:InvokeServer("GuitarPuzzleProgress","Check") == nil then
           ...
           elseif replicated.Remotes.CommF_:InvokeServer("GuitarPuzzleProgress","Check").Swamp == false then
             ...
             local v = GetConnectionEnemies("Living Zombie")
             if v then repeat task.wait()
                 Attack.Kill(v,_G.Auto_Soul_Guitar) until not _G.Auto_Soul_Guitar or v.Humanoid.Health <= 0
                     or not v.Parent
        ...
        until workspace.Map["Haunted Castle"].Tablet.Segment2.Line.Rotation.Z == 0 or workspace.Map["Haunted Castle"].Tablet.Segment5.Line.Rotation.Z == 0
            or workspace.Map["Haunted Castle"].Tablet.Segment6.Line.Rotation.Z == 0 or workspace.Map["Haunted Castle"].Tablet.Segment8.Line.Rotation.Z == 0
            or workspace.Map["Haunted Castle"].Tablet.Segment9.Line.Rotation.Z == 0
	    ...
	    if GetM("Bones") >= 500 and GetM("Ectoplasm") >= 250 and GetM("Dark Fragment") >= 1 then
		  ...
		  if GetM("Ectoplasm") <= 250 then
		    if _G.AutoMatSoul and World2 then
              ...
              if xz then repeat task.wait()
                  Attack.Kill(xz, _G.AutoMatSoul)until not _G.AutoMatSoul or not xz.Parent or xz.Humanoid.Health <= 0
			  else replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.21252441406, 126.9760055542,
			       32852.83203125))
			  end
		    else replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
		    end
		  elseif GetM("Dark Fragment") < 1 then
		    if _G.AutoMatSoul and World2 then
		      ...
		      if black then repeat task.wait()
		          Attack.Kill(black, _G.AutoMatSoul)until _G.AutoMatSoul or black.Humanoid.Health <= 0
		      else _tp(CFrame.new(3798.4575195313, 13.826690673828, -3399.806640625))
		      end
		    else replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
			end
      ...
      if _G.AcientOne then
	    ...
	    for i=1,#BonesTable do
	      ...
	      elseif plr.Character:FindFirstChild("RaceTransformed").Value == false then
	        ...
	        if v then repeat wait()
	            Attack.Kill(v, _G.AcientOne) until _G.AcientOne == false or v.Humanoid.Health <= 0 or not v.Parent
		    else _tp(CFrame.new(-9495.6806640625, 453.58624267578125, 5977.3486328125))
		    end
	      end
        end
      ...
      if _G.Complete_Trials then
	    if tostring(plr.Data.Race.Value) == "Fishman" then
	      if GetSeaBeastTrial() then
            repeat task.wait()
              spawn(function()
                  _tp(CFrame.new(GetSeaBeastTrial().HumanoidRootPart.Position.X,game:GetService("Workspace").Map["WaterBase-Plane"].Position.Y + 300,

                  GetSeaBeastTrial().HumanoidRootPart.Position.Z))end)
    ...
    pcall(function()
      if _G.Complete_Trials then
	    if tostring(plr.Data.Race.Value) == "Human" or tostring(plr.Data.Race.Value) == "Ghoul" then
          ...
          if v then repeat wait()
              Attack.Kill(v, _G.Complete_Trials)until _G.Complete_Trials == false or not v.Parent or v.Humanoid.Health <= 0 end
        end
      end
    end)
  end
...
repeat
              ...
              until _G.Defeating == false or v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart")
                  or not v:FindFirstChild("Humanoid")
            end
          end
        end
...
function printBeltName(data)
    if type(data) == "table" and data.Quest["BeltName"] then return data.Quest["BeltName"] end end
spawn(function()
  while wait(Sec) do
    if _G.Dojoo then
      pcall(function()
        ...
        elseif debug == true and (CFrame.new(5865.0234375, 1208.3154296875, 871.15185546875).Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 50 then
          if NameBelt == "White" then
            ...
            if v then repeat task.wait()
                Attack.Kill(v, _G.Dojoo) until not progress or not _G.Dojoo or not Attack.Alive(v)
...
if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                _G.Prehis_Find = true
                if workspace.Map.PrehistoricIsland.Core.ActivationPrompt:FindFirstChild("ProximityPrompt",
                    true) then
...
if workspace.Enemies:FindFirstChild(b)then
         for d,e in pairs(workspace.Enemies:GetChildren())do
             if e.Name==b and Attack.Alive(e)then
                 if a then
                     Attack.Kill(e,
    a)end end end else _tp(c)end end
spawn(function()
  while wait() do
        ...
        if a == true and not BackTODoJo() then
          ...
          elseif x == 2 then
            if workspace.Map.Waterfall.IslandModel:FindFirstChild("Meshes/bambootree", true) then
              repeat wait()
                spawn(function()
                    _tp(workspace.Map.Waterfall.IslandModel:FindFirstChild("Meshes/bambootree", true).CFrame * CFrame.new(4,
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V1)", Description = "turn on for auto quest1 auto prehistoric event + collect dragon eggs",
...
spawn(function()
  while wait(Sec) do
    if _G.AutoFireFlowers then
      ...
      local v = GetConnectionEnemies("Forest Pirate")
      if v then repeat wait()
          Attack.Kill(v,_G.AutoFireFlowers) until not _G.AutoFireFlowers or not v.Parent or v.Humanoid.Health <= 0
              or FireFlower
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V3)", Description = "turn on for sea event kill terror shark",
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Relic Drago Trial", Description = "turn on for auto trial v4 you have to COLLECT RELIC by your self",
...
_tp(CFrame.new(-39934.9765625, 10685.359375, 22999.34375))
              until not _G.Relic123 or (Root.Position == CFrame.new(-39934.9765625,
               10685.359375, 22999.34375).Position)
          repeat wait()
_tp(CFrame.new(-40511.25390625, 9376.4013671875, 23458.37890625))
              until not _G.Relic123 or (Root.Position == CFrame.new(-40511.25390625,
               9376.4013671875, 23458.37890625).Position)
          wait(2.5)
          repeat wait()
_tp(CFrame.new(-39914.65625, 10685.384765625, 23000.177734375))
              until not _G.Relic123 or (Root.Position == CFrame.new(-39914.65625,
               10685.384765625, 23000.177734375).Position)
          repeat wait()
_tp(CFrame.new(-40045.83203125, 9376.3984375, 22791.287109375))
              until not _G.Relic123 or (Root.Position == CFrame.new(-40045.83203125,
               9376.3984375, 22791.287109375).Position)
          wait(2.5)
          repeat wait()
              _tp(CFrame.new(-39908.5, 10685.4052734375, 22990.04296875)) until not _G.Relic123 or (Root.Position == CFrame.new(-39908.5,

               10685.4052734375, 22990.04296875).Position)
          repeat wait()
              _tp(CFrame.new(-39609.5, 9376.400390625, 23472.94335975)) until not _G.Relic123 or (Root.Position == CFrame.new(-39609.5,

               9376.400390625, 23472.94335975).Position)
        else
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Train Drago v4", Description = "turn on for training Drago race v4 + auto upgrade tier",
      ...
      if _G.TrainDrago then
	    ...
	    for i=1,#DragoM do
	      ...
	      elseif plr.Character:FindFirstChild("RaceTransformed").Value == false then
	        ...
	        if v then repeat wait()
	            Attack.Kill(v, _G.TrainDrago) until _G.TrainDrago == false or v.Humanoid.Health <= 0 or not v.Parent
...
spawn(function()
  while wait(Sec) do
    if _G.DT_Uzoth then
      local Uz_POS = CFrame.new(5661.89014, 1211.31909, 864.836731, 0.811413169, -1.36805838e-08, -0.584473014,
           4.75227395e-08,
           1, 4.25682458e-08, 0.584473014, -6.23161966e-08, 0.811413169)
      _tp(Uz_POS)
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Craft Volcanic Magnet", Description = "turn on for auto farm material and craft volcanic magnet & stop when you have 1 volcanic magnet",
      ...
      if _G.CraftVM then
        if GetM("Volcanic Magnet") < 1 then
          ...
          elseif GetM("Scrap Metal") < 10 then
            local v = GetConnectionEnemies("Forest Pirate")
            if v then repeat wait()
                Attack.Kill(v,_G.CraftVM) until not _G.CraftVM or not v.Parent or v.Humanoid.Health <= 0
                    or GetM("Scrap Metal") >= 10
            else _tp(CFrame.new(-13206.452148438, 425.89199829102, -7964.5537109375))
            end
          elseif GetM("Blaze Ember") < 15 then
            repeat wait()
                _G.FarmBlazeEM = true until not _G.CraftVM or GetM("Blaze Ember") >= 15 _G.FarmBlazeEM = false
          end
        end
      end
    end)
...
Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Find Prehistoric Island", Description = "turn on for finding & tween & start prehistoric island",
...
if (buyBoatCFrame.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10 then
            ...
            if plr.Character.Humanoid.Sit == false then
              ...
              until not _G.Prehis_Find or (targetDestination.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10
                  or workspace["_WorldOrigin"].Locations:FindFirstChild("Prehistoric Island") or plr.Character.Humanoid.Sit == false
                  plr.Character.Humanoid.Sit = false
            end
          end
        else
if (workspace["_WorldOrigin"].Locations:FindFirstChild("Prehistoric Island").CFrame.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 then
          ...
          if workspace.Map:FindFirstChild("PrehistoricIsland", true) or workspace["_WorldOrigin"].Locations:FindFirstChild("Prehistoric Island",

               true) then
            if workspace.Map.PrehistoricIsland.Core.ActivationPrompt:FindFirstChild("ProximityPrompt",
                 true) then
              if plr:DistanceFromCharacter(workspace.Map.PrehistoricIsland.Core.ActivationPrompt.CFrame.Position) <= 150 then
                fireproximityprompt(workspace.Map.PrehistoricIsland.Core.ActivationPrompt.ProximityPrompt,
                     math.huge)
                vim1:SendKeyEvent(true, "E", false, game)
                    wait(1.5)
                    vim1:SendKeyEvent(false, "E", false, game)
      ...
      if _G.Prehis_Skills then
        if workspace.Enemies:FindFirstChild("Lava Golem") then
          ...
          if v then repeat wait()
              ...
              v.Humanoid:ChangeState(15)until not _G.Prehis_Skills or not v.Parent or v.Humanoid.Health <= 0 end
        end
...
if workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs:FindFirstChild("DragonEgg") then
           _tp(workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs:FindFirstChild("DragonEgg").Molten.CFrame)
               fireproximityprompt(workspace.Map.PrehistoricIsland.Core.SpawnedDragonEggs.DragonEgg.Molten.ProximityPrompt,
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Reset When Complete Volcano", Description = "Reset When Complete Volcano not collect dino bones and else..",
...
local ListSeaBoat={"Guardian","PirateGrandBrigade","MarineGrandBrigade","PirateBrigade","MarineBrigade",
...
spawn(function()
  while wait(.1) do
    if _G.FrozenTP then
      pcall(function()
      if workspace.Map:FindFirstChild("LeviathanGate") then _tp(workspace.Map.LeviathanGate.CFrame)
          replicated:WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("OpenLeviathanGate") end
      end)
    end
  end
end)
...
spawn(function()
  while wait() do
    if _G.SailBoats then
      pcall(function()
        local myBoat = CheckBoat()
if not myBoat and not(CheckShark()and _G.Shark or CheckTerrorShark()and _G.TerrorShark or CheckFishCrew()
    and _G.MobCrew or CheckPiranha()
    and _G.Piranha)and not(CheckEnemiesBoat()and _G.FishBoat)and not(CheckSeaBeast()and _G.SeaBeast1)
        and not(_G.PGB and CheckPirateGrandBrigade())
    and not(_G.HCM and CheckHauntedCrew())and not(_G.Leviathan1 and CheckLeviathan())then
          local buyBoatCFrame = CFrame.new(-16927.451, 9.086, 433.864)
          TeleportToTarget(buyBoatCFrame)
if (buyBoatCFrame.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10 then
               replicated.Remotes.CommF_:InvokeServer("BuyBoat",
        ...
        elseif myBoat and not(CheckShark()and _G.Shark or CheckTerrorShark()and _G.TerrorShark or CheckFishCrew()
            and _G.MobCrew
            or CheckPiranha()and _G.Piranha)and not(CheckEnemiesBoat()and _G.FishBoat)and not(CheckSeaBeast()
                and _G.SeaBeast1)
and not(_G.PGB and CheckPirateGrandBrigade())and not(_G.HCM and CheckHauntedCrew())and not(_G.Leviathan1
    and CheckLeviathan())then
          if plr.Character.Humanoid.Sit == false then
            ...
            elseif _G.DangerSc == "Lv 2" then CFrameSelectedZone = CFrame.new(-26779.5215, 30.0005474,
                 -822.858032)
            elseif _G.DangerSc == "Lv 3" then CFrameSelectedZone = CFrame.new(-31171.957, 30.0001011,
                 -2256.93774)
            elseif _G.DangerSc == "Lv 4" then CFrameSelectedZone = CFrame.new(-34054.6875, 30.2187767,
                 -2560.12012)
            elseif _G.DangerSc == "Lv 5" then CFrameSelectedZone = CFrame.new(-38887.5547, 30.0004578,
                 -2162.99023)
            elseif _G.DangerSc == "Lv 6" then CFrameSelectedZone = CFrame.new(-44541.7617, 30.0003204,
                 -1244.8584)
            elseif _G.DangerSc == "Lv Infinite" then CFrameSelectedZone = CFrame.new(-10000000, 31, 37016.25)
            end
            repeat wait()
              if (not _G.FishBoat and CheckEnemiesBoat()) or (not _G.PGB and CheckPirateGrandBrigade())
                  or (not _G.TerrorShark
                  and CheckTerrorShark()) then
                _tp(CFrameSelectedZone * CFrame.new(0,150,0))
              else
                _tp(CFrameSelectedZone)
              end

            until _G.SailBoats==false or(CheckShark()and _G.Shark or CheckTerrorShark()and _G.TerrorShark
                or CheckFishCrew()
                and _G.MobCrew or CheckPiranha()and _G.Piranha)or CheckSeaBeast()and _G.SeaBeast1 or CheckEnemiesBoat()
                    and _G.FishBoat
                or _G.Leviathan1 and CheckLeviathan() or _G.HCM and CheckHauntedCrew() or _G.PGB and CheckPirateGrandBrigade()
               ...
               for a,b in pairs(workspace.SeaBeasts:GetChildren())do
                   if b:FindFirstChild("HumanoidRootPart")and b:FindFirstChild("Health")and b.Health.Value>0 then
                       repeat
                           task.wait()
                               spawn(function()
                              _tp(CFrame.new(b.HumanoidRootPart.Position.X,game:GetService("Workspace").Map["WaterBase-Plane"].Position.Y+200,

                                  b.HumanoidRootPart.Position.Z))
                          end
                          )
                      ...
                      until _G.SeaBeast1==false or not b:FindFirstChild("HumanoidRootPart")or not b.Parent
                          or b.Health.Value<=0
                  end
              end
          end
...
if _G.Leviathan1 then
           if workspace.SeaBeasts:FindFirstChild("Leviathan")then
               for a,b in pairs(workspace.SeaBeasts:GetChildren())do
                   if b:FindFirstChild("HumanoidRootPart")and b:FindFirstChild("Leviathan Segment")and b:FindFirstChild("Health")
                      ...
                      until _G.Leviathan1==false or not b:FindFirstChild("HumanoidRootPart")or not b.Parent
                          or b.Health.Value<=0
                  end
              end
          end
...
if (buyBoatCFrame.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10 then
            ...
            if plr.Character.Humanoid.Sit == false then
              ...
              until not _G.AutofindKitIs or (targetDestination.Position - plr.Character.HumanoidRootPart.Position).Magnitude <= 10
                  or workspace["_WorldOrigin"].Locations:FindFirstChild("Kitsune Island") or plr.Character.Humanoid.Sit == false
                  plr.Character.Humanoid.Sit = false
            end
          end
        else
          _tp(workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island").CFrame*CFrame.new(0,500,
              0))
        end
      end)
    end
        ...
        if shrineActive then
          for _, v in next, shrineActive:GetDescendants() do
            if v:IsA("BasePart") and v.Name:find("NeonShrinePart") then
              ...
              repeat wait()
                  _tp(v.CFrame * CFrame.new(0,2,0)) until _G.tweenShrine == false or not kit_is
            end
          end
        else
          _tp(workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island").CFrame * CFrame.new(0,
              500,0))
        end
      end)
    end
...
Q:OnChanged(function(Value)
  ...
  while _G.TpLab do wait(Sec)
   if _G.TpLab then
     ...
     elseif World3 and _G.TpLab then _tp(CFrame.new(-5017.40869, 314.844055, -2823.0127, -0.925743818,
          4.48217499e-08, -0.378151238,
          4.55503146e-09, 1, 1.07377559e-07, 0.378151238, 9.7681621e-08, -0.925743818)) end
   end
  end
end)
                ...
                if v:FindFirstChild("Humanoid") or v:FindFirstChild("HumanoidRootPart") then
                  if v.Humanoid.Health > 0 then
                    repeat wait()
                        ...
                        NextIs=false until not _G.Raiding or not v.Parent or v.Humanoid.Health <= 0 NextIs=true
                  end
                end
              end
            end
...
if workspace["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
             _tp(workspace["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,
            50,100))

        elseif workspace["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
         _tp(workspace["_WorldOrigin"].Locations:FindFirstChild("Island 4").CFrame*CFrame.new(0,
            50,100))

        elseif workspace["_WorldOrigin"].Locations:FindFirstChild("Island 3") then
         _tp(workspace["_WorldOrigin"].Locations:FindFirstChild("Island 3").CFrame*CFrame.new(0,
            50,100))

        elseif workspace["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
         _tp(workspace["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame*CFrame.new(0,
            50,100))

        elseif workspace["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
         _tp(workspace["_WorldOrigin"].Locations:FindFirstChild("Island 1").CFrame*CFrame.new(0,
            50,100))
        end
      end
    end
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Mink V3 [ INF ]", Description = "turn on for make mink v3 infinity",
     Default = false})
Q:OnChanged(function(Value)
  InfAblities = Value
end)
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Energy [ INF ]", Description = "turn on for make energy infinity",
     Default = false})
Q:OnChanged(function(Value)
  infEnergy = Value
  if Value then getInfinity_Ability("Energy", infEnergy) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Soru [ INF ]", Description = "turn on for make soru infinity",
     Default = false})
Q:OnChanged(function(Value)
  _G.InfSoru = Value
  if Value then getInfinity_Ability("Soru", _G.InfSoru) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Observation Range [ INF ]", Description = "turn on for make observation range infinity",
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Ignore Same Teams", Description = "turn on for ignore not aimbot same team",
     Default = false})
Q:OnChanged(function(Value)
  _G.NoAimTeam = Value
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Accept Allies", Description = "turn on for auto accept ally",
     Default = false})
Q:OnChanged(function(Value)
  _G.AcceptAlly = Value
end)
...
local __DARKLUA_CONTINUE_507=false
    repeat            if not SelectedIsland or Chest:IsDescendantOf(SelectedIsland) then
                if not Chest:GetAttribute("IsDisabled") then
                    local chestPos
                    local success, result = pcall(function()
                        return Chest:GetPivot().Position end)
                    if success then
                        chestPos = result
...
__DARKLUA_CONTINUE_507=true until true
    if not __DARKLUA_CONTINUE_507 then break end        end
    else
...
Travelllll = Tabs.Travel:AddDropdown("Travelllll",{Title = "Select Travelling",Values = Location,Multi = false,
    Default = 1})
Travelllll:OnChanged(function(Value)
  _G.Island = Value
end)
GoIsland = Tabs.Travel:AddToggle("GoIsland", {Title = "Auto Travel", Description = "Automatic teleport to pos island",
     Default = false})
...
PortalTP = Tabs.Travel:AddDropdown("PortalTP",{Title = "Select Portal",Values = Location_Portal,Multi = false,
    Default = 1})
...
Tabs.Travel:AddButton({Title = "requestEntrance", Description = "",Callback = function()
  ...
  elseif _G.Island_PT == "Temple of Time" then
    replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28310.0234, 14895.1123, 109.456741,
         -0.469690144,
         -2.85620132e-08, -0.882831335, -3.23509219e-08, 1, -1.51411736e-08, 0.882831335, 2.14487486e-08,
              -0.469690144))
  end
end})
...
GoNPCs = Tabs.Travel:AddToggle("GoNPCs", {Title = "Auto Tween to NPCs", Description = "Automatic teleport to pos Npcs",
     Default = false})
...
local DragonFruitRemote = replicated:WaitForChild("Remotes"):WaitForChild("CommF_")
local DragonBasicFruitStock = {}
local DragonMirageFruitStock = {}
local DragonFruitCatalog = {}
local DragonBasicFruitNames = {}
local DragonMirageFruitNames = {}
local DragonFruitCatalogNames = {}
local Sel_NFruit
local Sel_MFruit
local Sel_SniperFruit

local function ReadDragonFruitShop(IsMirage)
  local Success, Result = pcall(function()
    return DragonFruitRemote:InvokeServer("GetFruits", IsMirage == true)
  end)
  if Success and type(Result) == "table" then
    return Result
  end
  if not Success then
    _G.DragonHubFunctionError = "Fruit stock: " .. tostring(Result)
  end
  return {}
end

local function BuildDragonFruitList(Data)
  local AllNames = {}
  local SaleNames = {}
  local SaleMap = {}
  for _, FruitData in pairs(Data) do
    if type(FruitData) == "table" and type(FruitData.Name) == "string" then
      if not table.find(AllNames, FruitData.Name) then
        table.insert(AllNames, FruitData.Name)
      end
      if FruitData.OnSale == true and not SaleMap[FruitData.Name] then
        SaleMap[FruitData.Name] = true
        table.insert(SaleNames, FruitData.Name)
      end
    end
  end
  table.sort(AllNames)
  table.sort(SaleNames)
  return AllNames, SaleNames, SaleMap
end

local function MergeDragonFruitCatalog(Names)
  for _, Name in ipairs(Names) do
    if not DragonFruitCatalog[Name] then
      DragonFruitCatalog[Name] = true
      table.insert(DragonFruitCatalogNames, Name)
    end
  end
  table.sort(DragonFruitCatalogNames)
end

local function RefreshDragonFruitStock(UpdateControls)
  local SelectedBasic = _G.SelectFruit
  local SelectedMirage = _G.SelectMirageFruit
  local SelectedSniper = _G.SelectFruitSniper
  local BasicAll, BasicSale, BasicMap = BuildDragonFruitList(ReadDragonFruitShop(false))
  local MirageAll, MirageSale, MirageMap = BuildDragonFruitList(ReadDragonFruitShop(true))
  if #BasicAll > 0 then
    DragonBasicFruitNames = BasicSale
    DragonBasicFruitStock = BasicMap
  end
  if #MirageAll > 0 then
    DragonMirageFruitNames = MirageSale
    DragonMirageFruitStock = MirageMap
  end
  MergeDragonFruitCatalog(BasicAll)
  MergeDragonFruitCatalog(MirageAll)

  if UpdateControls then
    if Sel_NFruit and Sel_NFruit.Refresh then
      Sel_NFruit:Refresh(DragonBasicFruitNames)
      if SelectedBasic and DragonBasicFruitStock[SelectedBasic] then Sel_NFruit:SetValue(SelectedBasic) end
    end
    if Sel_MFruit and Sel_MFruit.Refresh then
      Sel_MFruit:Refresh(DragonMirageFruitNames)
      if SelectedMirage and DragonMirageFruitStock[SelectedMirage] then Sel_MFruit:SetValue(SelectedMirage) end
    end
    if Sel_SniperFruit and Sel_SniperFruit.Refresh then
      Sel_SniperFruit:Refresh(DragonFruitCatalogNames)
      if SelectedSniper and DragonFruitCatalog[SelectedSniper] then Sel_SniperFruit:SetValue(SelectedSniper) end
    end
  end
end

RefreshDragonFruitStock(false)

Sel_NFruit = Tabs.Fruit:AddDropdown("Sel_NFruit", {Title = "Select Fruit Stock", Values = DragonBasicFruitNames,
     Multi = false,
     Default = 1})
...
Tabs.Fruit:AddButton({Title = "Refresh Fruit Stock", Description = "Updates the fruits currently available",
     Callback = function()
  RefreshDragonFruitStock(true)
end})

local function PurchaseDragonFruit(Name, IsMirage)
  if type(Name) ~= "string" or Name == "" then
    _G.DragonHubFunctionError = "Select a fruit before buying"
    return false
  end
  RefreshDragonFruitStock(false)
  local Stock = IsMirage and DragonMirageFruitStock or DragonBasicFruitStock
  if not Stock[Name] then
    _G.DragonHubFunctionError = Name .. " is not in stock"
    return false
  end
  local Success, Result = pcall(function()
    return DragonFruitRemote:InvokeServer("PurchaseRawFruit", Name, IsMirage == true)
  end)
  _G.DragonFruitPurchaseResult = Result
  if not Success then
    _G.DragonHubFunctionError = "Buy fruit: " .. tostring(Result)
  end
  return Success
end

Tabs.Fruit:AddButton({Title = "Buy Basic Stock", Description = "Buys the selected fruit if it is still in stock",
     Callback = function()
  PurchaseDragonFruit(_G.SelectFruit, false)
end})

Sel_MFruit = Tabs.Fruit:AddDropdown("Sel_MFruit", {Title = "Select Mirage Fruit", Values = DragonMirageFruitNames,
     Multi = false,
     Default = 1})
Sel_MFruit:OnChanged(function(Value)
  _G.SelectMirageFruit = Value
end)

Tabs.Fruit:AddButton({Title = "Buy Mirage Stock", Description = "Buys the selected Mirage stock fruit",
     Callback = function()
  PurchaseDragonFruit(_G.SelectMirageFruit, true)
end})

Sel_SniperFruit = Tabs.Fruit:AddDropdown("Sel_SniperFruit", {Title = "Select Fruit Sniper", Values = DragonFruitCatalogNames,

     Multi = false, Default = 1})
Sel_SniperFruit:OnChanged(function(Value)
  _G.SelectFruitSniper = Value
end)

local DragonFruitSniperBusy = false
local function TryDragonFruitSniper()
  if not _G.AutoBuyFruitSniper or DragonFruitSniperBusy then return end
  DragonFruitSniperBusy = true
  RefreshDragonFruitStock(false)
  local Selected = _G.SelectFruitSniper
  if Selected and DragonBasicFruitStock[Selected] then
    PurchaseDragonFruit(Selected, false)
  end
...
AutoBuyFruitSniper:OnChanged(function(Value)
  _G.AutoBuyFruitSniper = Value == true
  if _G.AutoBuyFruitSniper then task.spawn(TryDragonFruitSniper) end
end)

task.spawn(function()
  while task.wait(0.5) do
    if _G.AutoBuyFruitSniper then TryDragonFruitSniper() end
  end
end)

task.spawn(function()
  while task.wait(10) do
    pcall(RefreshDragonFruitStock, true)
  end
end)

local DragonGachaBusy = false
local function TryDragonGacha(Force)
  if (not Force and not _G.Random_Auto) or DragonGachaBusy then return end
  DragonGachaBusy = true
  local Success, Result = pcall(function()
    return DragonFruitRemote:InvokeServer("Cousin", "Buy")
  end)
  _G.DragonGachaLastResult = Result
  if not Success then
    _G.DragonHubFunctionError = "Auto Random Fruit: " .. tostring(Result)
  end
  DragonGachaBusy = false
end

RandomFF = Tabs.Fruit:AddToggle("RandomFF", {Title = "Auto Random Fruit", Description = "Automatic random devil fruit",
     Default = false})
RandomFF:OnChanged(function(Value)
  _G.Random_Auto = Value == true
  if _G.Random_Auto then task.spawn(TryDragonGacha) end
end)

Tabs.Fruit:AddButton({Title = "Random Fruit Now", Description = "Tries to spin a fruit immediately", Callback = function()
  TryDragonGacha(true)
end})

task.spawn(function()
  while task.wait(0.1) do
    if _G.Random_Auto then TryDragonGacha() end
  end
end)
DropF = Tabs.Fruit:AddToggle("DropF", {Title = "Auto Drop Fruit", Description = "Automatic drop devil fruit",
     Default = false})
...
StoredF = Tabs.Fruit:AddToggle("StoredF", {Title = "Auto Store Fruit", Description = "Automatic store devil fruit",
     Default = false})
...
TwF = Tabs.Fruit:AddToggle("TwF", {Title = "Auto Tween to Fruit", Description = "Automatic tween to get devil fruit",
     Default = false})
...
BringF = Tabs.Fruit:AddToggle("BringF", {Title = "Auto Collect Fruit", Description = "Automatic bring devil fruit",
     Default = false})
...
spawn(function()
  while wait(Sec) do
    if _G.InstanceF then
      pcall(function()
          collectFruits(_G.InstanceF) end)
    end
  end
end)
...
local function fetchServersData(placeId, limit)
    local url = string.format("https://games.roblox.com/v1/games/%d/servers/Public?limit=%d", placeId,
         limit)
    local success, response = pcall(function()
...
DisbleLeaderB = Tabs.Misc:AddToggle("DisbleLeaderB", {Title = "Disable Leader Board GUI", Description = "",
     Default = false})
...
UnPortal = Tabs.Misc:AddToggle("UnPortal", {Title = "Unlock All Portals", Description = "unlocked portal for who doesn't defeat rip_indra",
    ...
    pcall(function()
      if _G.PortalUnLock then
         ...
         elseif Attack.Pos(Man3Pos_Miti,8) then
           replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5072.08984375, 314.5412902832,
                -3151.1098632812))
         elseif Attack.Pos(HydraPos_Miti,8) then
           replicated.Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5748.7587890625, 610.44982910156,
                -267.81704711914))
...
HakiStat = Tabs.Misc:AddDropdown("HakiStat",{Title = "Select Haki States",Values = HakiSt,Multi = false,
    Default = 1})
...
Tabs.Misc:AddButton({Title = "Rain Fruits (Client)", Description = "",Callback = function()
  for i, v in pairs(game:GetObjects("rbxassetid://14759368201")[1]:GetChildren()) do
    ...
    v:MoveTo(plr.Character.PrimaryPart.Position + Vector3.new(math.random(-50, 50), 100, math.random(-50,
         50)))
...
walkWater = Tabs.Misc:AddToggle("walkWater", {Title = "Turn on Walk on Water", Description = "walk on water",
     Default = true})
...
iceWalk = Tabs.Misc:AddToggle("iceWalk", {Title = "Turn on Ice Walk", Description = "Ice walk just like walk on water but have ice effect",
    ...
    if _G.WalkWater then
      pcall(function()
	   ...
	   local upval0 = replicated.Assets.Models.IceSpikes4:Clone()
        ...
        upval0.CFrame = CFrame.new(plr.Character.Head.Position.X,-3.8,plr.Character.Head.Position.Z)*CFrame.Angles((math.random()-0.5)*0.06,

             math.random()*7,(math.random()-0.5)*0.07)
        local var85={};
...
task.spawn(function()
  RunSer.Heartbeat:Connect(function()
    pcall(function()
      ...
      local AttackDelay = math.clamp(tonumber(_G.DragonAttackDelay) or 0.2, 0.05, 0.5)
      if tick() - (_G.DragonLastSerialAttack or 0) < AttackDelay then return end
      _G.DragonLastSerialAttack = tick()
      AttackNoCoolDown()
      ...
      if ToolTip == "Blox Fruit" then
        if MobAura then
          ...
          if LeftClickRemote then Actived()
              LeftClickRemote:FireServer(Vector3.new(0.01,-500,0.01),1,true);LeftClickRemote:FireServer(false)end
        end
      end
    end)
  end)
...
task.spawn(function()
local SeaName = World1 and "Sea 1" or World2 and "Sea 2" or World3 and "Sea 3" or "Unknown"
local DragonAutoState = "Parado"
local DragonObjective = nil
local MaxLevel = 2800
...
Tabs.Automatic:AddParagraph({
  Title = "Skipped automatic objectives",
  Content = "Race V4 trials, V4 blue gear, Mirage Island, Kitsune Island, Leviathan and rewards that require Leviathan Heart"
})

local function SetDragonStatus(Value)
  DragonAutoState = Value
  if _G.DragonStatusLabel then
    _G.DragonStatusLabel.Text = Value
  end
  pcall(function()
    DragonStatus:SetDesc(Value)
  end)
end

local DragonFlags = {
  "Level", "TravelDres", "AutoZou", "AutoSaber", "AutoPole", "KeysRen",
  "Auto_SuperHuman", "AutoDeathStep", "Auto_SharkMan_Karate",
  "Auto_Electric_Claw", "AutoDragonTalon", "Auto_God_Human", "AutoGodHuman",
  "FarmEliteHunt", "Auto_Tushita", "Auto_Yama", "CDK", "CDK_YM", "CDK_TS",
  "Auto_Soul_Guitar", "AutoMatSoul", "AutoSaw", "WardenBoss", "MarinesCoat",
  "AutoGetUsoap", "Greybeard", "SwanCoat", "AutoLawKak", "AutoTridentW2", "AutoEcBoss",
  "Auto_SwanGG", "AutoBigmom", "Auto_Cavender", "TwinHook", "AutoSerpentBow",
  "AutoKilo", "LongsWord", "BlackSpikey", "AutoHytHallow"
}

local DragonShopItems = {
  {"Cutlass", "BuyItem", "Cutlass"},
  {"Katana", "BuyItem", "Katana"},
  {"Iron Mace", "BuyItem", "Iron Mace"},
  {"Dual Katana", "BuyItem", "Duel Katana"},
  {"Triple Katana", "BuyItem", "Triple Katana"},
  {"Pipe", "BuyItem", "Pipe"},
  {"Dual-Headed Blade", "BuyItem", "Dual-Headed Blade"},
  {"Bisento", "BuyItem", "Bisento"},
  {"Soul Cane", "BuyItem", "Soul Cane"},
  {"Slingshot", "BuyItem", "Slingshot"},
  {"Musket", "BuyItem", "Musket"},
  {"Dual Flintlock", "BuyItem", "Dual Flintlock"},
  {"Flintlock", "BuyItem", "Flintlock"},
  {"Refined Flintlock", "BuyItem", "Refined Flintlock"},
  {"Cannon", "BuyItem", "Cannon"},
  {"Tomoe Ring", "BuyItem", "Tomoe Ring"},
  {"Black Cape", "BuyItem", "Black Cape"},
  {"Swordsman Hat", "BuyItem", "Swordsman Hat"}
}

local function ClearDragonObjective()
  for _, Name in ipairs(DragonFlags) do
    _G[Name] = false
  end
end

local function ReadDragonInventory()
  local Inventory = {}
  pcall(function()
  ...
  for _, Container in ipairs({plr.Backpack, plr.Character}) do
    if Container then
      for _, Item in ipairs(Container:GetChildren()) do
        Inventory[Item.Name] = Inventory[Item.Name] or Item
      end
    end
  end
  return Inventory
...
local function SetDragonObjective(Name, Status, Flags)
  if DragonObjective ~= Name then
    ClearDragonObjective()
    DragonObjective = Name
  end
  for Flag, Value in pairs(Flags or {}) do
    _G[Flag] = Value
  end
  if _G.DragonObjectiveLabel then
    _G.DragonObjectiveLabel.Text = "Objetivo: " .. tostring(Name or "nenhum")
  end
  SetDragonStatus(Status)
end

local function TravelToSea(Name)
  SetDragonObjective("Travel:" .. Name, "Traveling to " .. Name, {})
  if Name == "Sea 1" then
    replicated.Remotes.CommF_:InvokeServer("TravelMain")
  elseif Name == "Sea 2" then
    replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
  elseif Name == "Sea 3" then
    replicated.Remotes.CommF_:InvokeServer("TravelZou")
  end
end
...
Tabs.Automatic:AddButton({
  ...
  Description = "Stops the automatic controller until the script is executed again",
  Callback = function()
    _G.DragonAutoEnabled = false
    _G.DragonAuto = false
    DragonObjective = nil
...
local DragonCodesAttempted = false
local DragonStateDirty = true
local DragonLastCheck = 0

local function MarkDragonStateDirty()
  Lv = plr.Data.Level.Value
  DragonStateDirty = true
  if _G.DragonWorldLabel then
    _G.DragonWorldLabel.Text = "Mundo: " .. SeaName .. " | Nivel: " .. tostring(Lv)
  end
end

local function WatchDragonContainer(Container)
  if not Container then return end
  Container.ChildAdded:Connect(MarkDragonStateDirty)
  Container.ChildRemoved:Connect(MarkDragonStateDirty)
end

plr.Data.Level:GetPropertyChangedSignal("Value"):Connect(MarkDragonStateDirty)
if plr.Data:FindFirstChild("Beli") then plr.Data.Beli:GetPropertyChangedSignal("Value"):Connect(MarkDragonStateDirty) end
if plr.Data:FindFirstChild("Fragments") then plr.Data.Fragments:GetPropertyChangedSignal("Value"):Connect(MarkDragonStateDirty) end
WatchDragonContainer(plr.Backpack)
WatchDragonContainer(plr.Character)
plr.CharacterAdded:Connect(function(Character)
  WatchDragonContainer(Character)
  MarkDragonStateDirty()
end)

local function RedeemDragonXPCodes()
  if DragonCodesAttempted then return end
  DragonCodesAttempted = true
  local RedeemRemote = replicated.Remotes:FindFirstChild("Redeem")
  if not RedeemRemote then return end
  SetDragonStatus("Resgatando codigos de 2x XP")
  for _, Code in ipairs(DragonXPCodes) do
    pcall(function()
  ...
  SetDragonStatus("Codigos de XP verificados | Analisando conta")
end

_G.DragonStopAll = function()
  _G.DragonAutoEnabled = false
  _G.DragonAuto = false
  DragonObjective = nil
  ClearDragonObjective()
  ...
  _G.Random_Auto = false
  SetDragonStatus("Parado")
  if _G.DragonObjectiveLabel then _G.DragonObjectiveLabel.Text = "Objetivo: nenhum" end
end

_G.DragonStartAll = function()
  _G.DragonAutoEnabled = true
  _G.DragonAuto = true
  _G.ChooseWP = "Melee"
  _G.Auto_Melee = true
  ...
  _G.tweenKitsune = false
  _G.Collect_Ember = false
  _G.Leviathan1 = false
  _G.Complete_Trials = false
  _B = true
  Boud = true
  if not pSats or pSats < 1 then pSats = 10 end
  DragonStateDirty = true
  SetDragonStatus("Analisando conta")
  if _G.DragonObjectiveLabel then _G.DragonObjectiveLabel.Text = "Objetivo: analisando nivel, mundo e inventario" end
  task.spawn(RedeemDragonXPCodes)
end

if _G.DragonStartRequested then
  _G.DragonStartAll()
end
  ...
  while task.wait(0.25) do
    if _G.DragonSelectedMode == "AUTOMATIC" and _G.DragonAutoEnabled and (DragonStateDirty or os.clock() - DragonLastCheck >= 5) then
      ...
      pcall(function()
        ...
        Lv = CurrentLevel
        if _G.DragonWorldLabel then
          _G.DragonWorldLabel.Text = "Mundo: " .. SeaName .. " | Nivel: " .. tostring(CurrentLevel)
        end
        local Inventory = ReadDragonInventory()
        local function Owns(Name)
          return Inventory[Name] ~= nil
        end
        local function MissingDrop(Goals)
          for _, Goal in ipairs(Goals) do
            if not Owns(Goal[1]) then
              return Goal
            end
          end
        end
        ...
        if World1 then
          if CurrentLevel >= 200 and not Owns("Saber") then
            SetDragonObjective("Saber", "Getting Saber | Missing item detected", {AutoSaber = true})
          elseif CurrentLevel < 700 then
            SetDragonObjective("Level", "Farming levels | Sea 1 | Level " .. tostring(CurrentLevel), {Level = true})
          elseif CurrentLevel >= MaxLevel then
            local Goal = MissingDrop({
              {"Pole (1st Form)", "AutoPole"},
              {"Shark Saw", "AutoSaw"},
              {"Wardens Sword", "WardenBoss"},
              {"Coat", "MarinesCoat"},
              {"Pink Coat", "SwanCoat"},
              {"Usoap's Hat", "AutoGetUsoap"}
            })
            if Goal then
              SetDragonObjective(Goal[1], "Getting " .. Goal[1] .. " | Missing solo item", {[Goal[2]] = true})
            else
              SetDragonObjective("Sea2", "Sea 1 solo objectives complete | Going to Sea 2", {TravelDres = true})
            end
          else
            SetDragonObjective("Sea2", "Unlocking Sea 2 | Level " .. tostring(CurrentLevel), {TravelDres = true})
          end
        elseif World2 then
          if CurrentLevel < 1500 then
            SetDragonObjective("Level", "Farming levels | Sea 2 | Level " .. tostring(CurrentLevel), {Level = true})
          elseif CurrentLevel < MaxLevel then
            SetDragonObjective("Sea3", "Unlocking Sea 3 | Level " .. tostring(CurrentLevel), {AutoZou = true})
          elseif not Owns("Rengoku") then
            SetDragonObjective("Rengoku", "Getting Rengoku | Missing item detected", {KeysRen = true})
          elseif not Owns("Death Step") then
            SetDragonObjective("DeathStep", "Getting Death Step | Missing style detected", {AutoDeathStep = true})
          elseif not Owns("Sharkman Karate") then
            SetDragonObjective("Sharkman", "Getting Sharkman Karate | Missing style detected", {Auto_SharkMan_Karate = true})
          else
            local Goal = MissingDrop({
              {"Koko", "AutoLawKak"},
              {"Dragon Trident", "AutoTridentW2"},
              {"Midnight Blade", "AutoEcBoss"},
              {"Swan Glasses", "Auto_SwanGG"},
              {"Longsword", "LongsWord"}
            })
            if Goal then
              SetDragonObjective(Goal[1], "Getting " .. Goal[1] .. " | Missing solo item", {[Goal[2]] = true})
            else
              SetDragonObjective("ReturnSea3", "Sea 2 solo objectives complete | Returning to Sea 3",
                   {})
              replicated.Remotes.CommF_:InvokeServer("TravelZou")
            end
          end
        elseif World3 then
          if CurrentLevel < MaxLevel then
            SetDragonObjective("Level", "Farming levels | Sea 3 | Level " .. tostring(CurrentLevel), {Level = true})
          elseif MissingAny({"Saber", "Pole (1st Form)", "Shark Saw", "Wardens Sword", "Coat", "Pink Coat",
               "Usoap's Hat"}) then
            TravelToSea("Sea 1")
          elseif MissingAny({"Rengoku", "Death Step", "Sharkman Karate", "Koko", "Dragon Trident", "Midnight Blade",
               "Swan Glasses",
               "Longsword"}) then
            TravelToSea("Sea 2")
          elseif not Owns("Superhuman") then
            SetDragonObjective("Superhuman", "Getting Superhuman | Missing style detected", {Auto_SuperHuman = true})
          elseif not Owns("Electric Claw") then
            SetDragonObjective("ElectricClaw", "Getting Electric Claw | Missing style detected", {Auto_Electric_Claw = true})
          elseif not Owns("Dragon Talon") then
            SetDragonObjective("DragonTalon", "Getting Dragon Talon | Missing style detected", {AutoDragonTalon = true})
          elseif not Owns("Tushita") then
            SetDragonObjective("Tushita", "Getting Tushita | Missing sword detected", {Auto_Tushita = true})
          elseif not Owns("Yama") then
            SetDragonObjective("Yama", "Getting Yama | Completing Elite Hunter progress", {Auto_Yama = true,
                 FarmEliteHunt = true})
          elseif not Owns("Cursed Dual Katana") then
            SetDragonObjective("CDK", "Getting Cursed Dual Katana | Missing sword detected", {CDK = true,
                 CDK_YM = true, CDK_TS = true})
          elseif not Owns("Skull Guitar") then
            SetDragonObjective("SkullGuitar", "Getting Skull Guitar | Missing weapon detected", {Auto_Soul_Guitar = true,

                 AutoMatSoul = true})
          elseif not Owns("Godhuman") then
            SetDragonObjective("Godhuman", "Getting Godhuman | Missing style detected", {Auto_God_Human = true,
                 AutoGodHuman = true})
          else
            local Goal = MissingDrop({
              {"Buddy Sword", "AutoBigmom"},
              {"Canvander", "Auto_Cavender"},
              {"Twin Hooks", "TwinHook"},
              {"Serpent Bow", "AutoSerpentBow"},
              {"Lei", "AutoKilo"},
              {"Spikey Trident", "BlackSpikey"},
              {"Hallow Scythe", "AutoHytHallow"}
            })
            if Goal then
              SetDragonObjective(Goal[1], "Getting " .. Goal[1] .. " | Missing solo item", {[Goal[2]] = true})
            else
              local ShopGoal = nil
              for _, Item in ipairs(DragonShopItems) do
                if not Owns(Item[1]) then
                  ShopGoal = Item
                  break
                end
              end
              if ShopGoal then
                SetDragonObjective("Shop:" .. ShopGoal[1], "Buying " .. ShopGoal[1] .. " | Missing shop item",
                     {Level = true})
                replicated.Remotes.CommF_:InvokeServer(ShopGoal[2], ShopGoal[3])
              else
                SetDragonObjective("Complete", "All supported solo objectives complete | Multiplayer objectives skipped",

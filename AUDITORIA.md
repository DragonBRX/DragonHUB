...
- 187 toggles com módulo individual criptografado.
- 205 callbacks de toggle, dropdown e slider registrados pelo runtime.
- 91 ações de botão registradas pelo runtime.
- Nenhum módulo individual ausente no código-fonte ou na pasta criptografada.
...
- Fonte e versão criptografada conferidas por decodificação byte a byte: 203 arquivos sem divergências.
- Registro de funções, layout e arquivos criptografados: nenhuma referência ausente.
